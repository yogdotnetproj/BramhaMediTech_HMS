<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="MRC_PatientListFor.aspx.cs" Inherits="MRC_PatientListFor" %>
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>MRC IPD patient list for payment</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">MRC IPD patient list for payment</li>
                    </ol>
            </section>
                                            ...
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="IpdId"
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:BoundField DataField="BalancebroughtForward"  HeaderText="BalancebroughtForward" ItemStyle-Width="100"  >
