<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OPDPatientRegistration.aspx.cs" Inherits="OPDPatientRegistration" %>
                ...
                <input id="rdbdiscPer" type="radio" runat="server" name="rdbDisc" value="Per" />
                  <label for="rdbdiscPer">Per(%)</label>
                                    ...
                                    <asp:Button ID="btnSaveandBill" runat="server" Text="Save & Bill" OnClientClick="return Validate1();"
                                        CausesValidation="False" TabIndex="16" Visible="false" CssClass="btn btn-primary"  
                                        onclick="btnSaveandBill_Click"   /><%-- onclientclick="target = '_blank';" />--%>
                                             <asp:Button ID="btnCaseReport" runat="server" Visible="false" Text="Case Report" OnClientClick="target = '_blank';"
                                        CausesValidation="False" TabIndex="16" CssClass="btn btn-primary"  OnClick="btnCaseReport_Click"/>

                                    <asp:Button ID="btnConsultation" runat="server" Visible="false" Text="Consultation" onclientclick="target = '_blank';"
                                        CausesValidation="False" TabIndex="16" CssClass="btn btn-primary"  onclick="btnConsultation_Click" />
                                        <asp:Button ID="btnRdlcReport" runat="server" Visible="false" Text="RDLC Report" 
                                        CausesValidation="False" TabIndex="16" CssClass="btn btn-primary" 
