...
public partial class SpecialityProductivityData : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        Alterview();
        Session.Add("rptsql", "");
        Session["rptname"] = Server.MapPath("~/Reports/Rpt_SpecialityProductivityData.rpt");
        Session["reportname"] = "SpecialityProductivityData";
    ...
    public void Alterview()
    {
        ...
        string query = "ALTER VIEW [dbo].[VW_SpecialityProductivityData] AS (SELECT        OpdRegistration.OpdNo, OpdRegistration.TokenNo, OpdRegistration.PatRegId, OpdRegistration.DrId, OpdRegistration.VisitingNo, OpdRegistration.Entrydate, OpdRegistration.RegistrationType, OpdRegistration.ReferenceDoc, " +
                  ...
                  "  Month(OpdRegistration.Createdon) as SurgicalMonth,Year(OpdRegistration.Createdon) as SurgicalYear , DepartmentMst.DeptName  " +
                  " FROM            OpdRegistration INNER JOIN "+
                  "  HospEmpMst ON OpdRegistration.DrId = HospEmpMst.DrId INNER JOIN "+
                  "  DepartmentMst ON OpdRegistration.DeptId = DepartmentMst.DeptId "+
    ...
    protected void btnChart_Click(object sender, EventArgs e)
    {
        Alterview();
        Session.Add("rptsql", "");
        Session["rptname"] = Server.MapPath("~/Reports/Rpt_SpecialityProductivityData_Chart.rpt");
        Session["reportname"] = "SpecialityProductivityChart";
        Session["RPTFORMAT"] = "pdf";
