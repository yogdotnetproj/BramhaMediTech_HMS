<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="PatientrecommendationList.aspx.cs" Inherits="PatientrecommendationList" %>
                               ...
                               <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnReport"  runat="server" Text="Report" Visible="false" TabIndex="3" ValidationGroup="Date" CssClass="btn btn-warning btnSearch" OnClick="btnReport_Click" />
                                        </div>
                                            </div>
                                    </div>
                                </div>
