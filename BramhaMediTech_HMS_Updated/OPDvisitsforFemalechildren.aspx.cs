...
public partial class OPDvisitsforFemalechildren : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (PatientInformation.AgeType <> 'Years' OR PatientInformation.Age < 10)  and Gender.GenderName= 'Female'";
        if (txtFrom.Value != "" && txtTo.Value != "")
        {
            query += " and    OpdRegistration.Entrydate between ('" + Convert.ToDateTime(txtFrom.Value).ToString("MM/dd/yyyy") + "') and ('" + Convert.ToDateTime(txtTo.Value).AddDays(1).ToString("MM/dd/yyyy") + "')";
        }
    ...
    public void BindGrid()
    {
        ...
        dt = ObjDPI.FillGrid_OpdVisitChildren();
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_OpdVisitFemaleChildren.rpt");
        Session["reportname"] = "Rpt_OpdVisitFemaleChildren";
