<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="EmergencyObservations.aspx.cs" Inherits="EmergencyObservations" %>
            ...
            <div class="box-body">
                                 ...
                                 <div class="row mt-3">
                                    ...
                                    <div class="col-lg-4 text-left">
                                        <div class="form-group">
                                            <label for="txtDays">Quantity <span style="color: red">*</span></label>
                                             </div>
                                    </div>
                                 ...
                                 <div class="row mt-3">
                                    <div class="col-lg-5">
                                        ...
                                        <asp:Button ID="btnAdd" runat="server" TabIndex="6" Text="Add" OnClick="btnAdd_Click"
                                            class="btn btn-info" CausesValidation="False" />
               ...
               <div class="col-lg-12 mt-3 text-center">
                             ...
                             <asp:Button ID="btnreport" runat="server" Text="Prescription" 
                                           class="btn btn-primary btnSearch" CausesValidation="False" OnClick="btnreport_Click" />
