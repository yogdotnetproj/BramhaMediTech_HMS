<%@ Page Title="" Language="C#" MasterPageFile="~/OT_mainMaster.master" AutoEventWireup="true" CodeFile="OPERATIVEHYSTEROSCOPY.aspx.cs" Inherits="OPERATIVEHYSTEROSCOPY" %>
     ...
     <Triggers>
        ...
        <ContentTemplate>
            <section class="content-header d-flex">
                    <h1>OPERATIVE HYSTEROSCOPY</h1>
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">OPERATIVE HYSTEROSCOPY</li>
                    </ol>                
                </section>
                    ...
                    <div class="row">
                        <div class="panel-heading">
                            <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <strong>OPERATIVE HYSTEROSCOPY</strong>
                                        </div>
                                </div>
                        </div>
                                          ...
                                          <asp:ListItem Value=""></asp:ListItem>
                                            ...
                                            <div class="form-group">
                                              Number
                                                     ...
                                                     <div class="col-sm-4" >
                                            <div class="form-group">
                                                     <asp:TextBox ID="txtnumber" CssClass="form-control"   runat="server" placeholder="" ></asp:TextBox>
                                            ...
                                            Location
                                                          ...
                                                          <div class="col-sm-4" >
                                            <div class="form-group">
                                             <asp:TextBox ID="txtLocation" CssClass="form-control"   runat="server" placeholder="" ></asp:TextBox>
                                                </div>
                                    </div>
                                                          <div class="col-sm-2" >
                                            <div class="form-group">
                                                size in CMs
                                                           ...
                                                           <div class="col-sm-2" >
                                            <div class="form-group">
                                             <asp:TextBox ID="txtsize" CssClass="form-control"   runat="server" placeholder="" ></asp:TextBox>
                                                </div>
                                    </div>
                                                      </div>
                                                     </div>
                                          ...
                                          <asp:ListItem Value=""></asp:ListItem>
                                            ...
                                            <div class="form-group">
                                              Septum
                                                           ...
                                                           <div class="col-sm-4" >
                                            <div class="form-group">
                                                     <asp:DropDownList ID="ddlSeptum"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                                <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                <asp:ListItem Value="No">No</asp:ListItem>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                              <asp:CheckBox runat="server" ID="chkFibroidResectionDone" Text="Fibroid Resection Done" />
                                                </div>
                                    </div>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                              <asp:CheckBox runat="server" ID="chkSeptalResectionDone" Text="Septal Resection Done" />
                                                </div>
                                    </div>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                              <asp:CheckBox runat="server" ID="chkAdhesiolysis" Text="Adhesiolysis" />
                                                </div>
                                    </div>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                               <asp:TextBox ID="txtcomments" CssClass="form-control" TextMode="MultiLine" Height="100px"  runat="server" placeholder="" ></asp:TextBox>
