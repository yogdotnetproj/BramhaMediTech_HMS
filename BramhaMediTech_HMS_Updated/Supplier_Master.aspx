<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="Supplier_Master.aspx.cs" Inherits="Supplier_Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     <script type = "text/javascript">
         function Validate() {
             ...
             if (document.getElementById("MainContent_txtRoomType").value == "") {
                 alert("Please Enter ");
                 return false;
             }
         }
    ...
    <section class="content-header d-flex">
      ...
      <section class="content">
                            ...
                            <asp:GridView ID="gvRoomType" runat="server" AutoGenerateColumns="False" DataKeyNames="Suppid"
                            class="table table-responsive table-sm table-bordered" Width="100%" 
                            AlternatingRowStyle-BackColor="White" HeaderStyle-ForeColor="Black" 
                            CellPadding="3" AllowPaging="True" PageSize="10"
                            OnRowDeleting="gvRoomType_RowDeleting" OnRowEditing="gvRoomType_RowEditing"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Suppid" HeaderText="RTypeId" Visible="False" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtRoomType">Supplier Name:</label>                                                                                
                                                    </div>
                                         </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">                                                    
                                              
                                              <asp:TextBox ID="txtRoomType" runat="server" placeholder="Enter Supplier Name(*)" CssClass="form-control" 
