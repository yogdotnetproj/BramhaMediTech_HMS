...
public partial class MonthlySurgicalProductivityData : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            Alterview();
            Session.Add("rptsql", "");
            Session["rptname"] = Server.MapPath("~/Reports/Rpt_Monthly_SurgicalProductivityData.rpt");
            Session["reportname"] = "Month_SurgicalProductivityData";
