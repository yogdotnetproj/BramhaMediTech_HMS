...
public partial class InsuranceSummaryForLAB : System.Web.UI.Page
{
    ...
    public void refreshdata()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("usp_GetInsuranceSummaryForLAB", con))
            {
    ...
    protected void Print_Click(object sender, EventArgs e)
    {
        ...
        objreports.InsuranceSummaryForLab_ForChild(start, end, PatRegId, BillGroup, InsuranceId, FId, BranchId);

        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Reports/Rpt_InsuranceSummaryLAB.rpt");
        Session["reportname"] = "InsuranceSummaryLAB";
        Session["RPTFORMAT"] = "pdf";
