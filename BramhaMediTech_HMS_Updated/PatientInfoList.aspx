<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="PatientInfoList.aspx.cs" Inherits="PatientInfoList" %>
                             ...
                             <AlternatingRowStyle BackColor="#95deff"></AlternatingRowStyle>
                               ...
                               <asp:BoundField DataField="CreatedBy" HeaderText="Created By" 
                                    ...
                                    <ItemStyle HorizontalAlign="Left"  />
                                              ...
                                              <asp:CommandField ButtonType="Image" HeaderText="Register" DeleteImageUrl="~/Images0/logout-32.png" 
                                    ShowCancelButton="False" ShowDeleteButton="True">
                                    <ItemStyle HorizontalAlign="Center" Width="50px"/>
                                </asp:CommandField>
                                            <asp:TemplateField HeaderText="Merge">
                                                <ItemTemplate>
                                                    <asp:CheckBox runat="server" ID="ChkMerge" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            </Columns>
