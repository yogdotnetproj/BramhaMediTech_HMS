...
public partial class EMR_RadioLabPatientRegistration : BaseClass
{
    ...
    protected BELOPDPatReg WriteDO()
    {
       ...
       // objBELOpdReg.WardName = Convert.ToString(ddlWardName.SelectedItem.Text);
    ...
    {
        GvNoteIngrid.DataSource = transaction.GetLabInvestigationDetailsRadio_IPD(PatRegId, IPDNo);
    ...
    private void BindTreamentGrid(int PatRegId)
    {
       ...
       // GvNoteIngrid.DataSource = transaction.GetLabInvestigationDetailsRadio(PatRegId);
        dtradio = transaction.GetLabInvestigationDetailsRadio(PatRegId);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
       ...
       // DropDownList ddl_Receipt = GvNoteIngrid.Rows[row.RowIndex].FindControl("ddlReceipt") as DropDownList;
        ...
        if (HdnPType.Value == "MediallLab")
        {
            ...
            Session["rptname"] = Server.MapPath("~/Reports/Pateintreportnondescriptive_MediLab.rpt");
        ...
        if (HdnPType.Value == "Radiology")
        {
            ...
            Session.Add("rptsql", sql);
            // Session["rptname"] = Server.MapPath("~/Reports/Rpt_DischargeSummaryReport.rpt");
            Session["rptname"] = Server.MapPath("~/Reports/Pateintreportdescriptive_Radio.rpt");
