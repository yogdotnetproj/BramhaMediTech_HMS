...
public partial class MaterinalDeathPatient : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where DeliveryNote.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and   DeliveryNote.MaternialDeath='True' ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VisitForMaterinalDeathPatient.rpt");
        Session["reportname"] = "Rpt_VisitForMaterinalDeathPatient";
