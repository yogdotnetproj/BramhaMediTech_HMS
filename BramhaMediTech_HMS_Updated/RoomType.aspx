<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="RoomType.aspx.cs" Inherits="RoomType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section class="content-header d-flex">
      ...
      <section class="content">
                            ...
                            <asp:GridView ID="gvRoomType" runat="server" AutoGenerateColumns="False" DataKeyNames="RTypeId"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="RTypeId" HeaderText="RTypeId" Visible="False" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">                                                    
                                              ...
                                              <asp:TextBox ID="txtRoomType" runat="server" placeholder="Enter Room Type(*)" CssClass="form-control" 
