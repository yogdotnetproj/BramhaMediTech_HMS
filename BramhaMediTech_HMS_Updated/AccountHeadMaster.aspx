<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="AccountHeadMaster.aspx.cs" Inherits="AccountHeadMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section class="content-header d-flex">
                    <h1>Account Head Master</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Account Head Master</li>
                    </ol>
                </section>
      ...
      <section class="content">
                            ...
                            <asp:GridView ID="gvDepartment" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AccHead" HeaderText="Account Head"/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-3" >
                                                    <div class="form-group">
                                                         <label for="txtDepartmentName" style="text-align:left">Account Head:</label>                                                                                
                                                    </div>
                                         </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">                                                    
                                              
                                              <asp:TextBox ID="txtDepartmentName" runat="server" placeholder="Enter Account HEad (*)" Class="form-control" 
                                        ...
                                        <div class="col-lg-12-3">
                                             <div class="row mb-3"> 
                                                  <div class="col-lg-3" >
                                                    <div class="form-group">
                                                         <label for="txtdeptcode" style="text-align:left">Account Code:</label>                                                                                
                                                    </div>
                                         </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">                                                    
                                              
                                              <asp:TextBox ID="txtdeptcode" runat="server" placeholder="Enter Account Code (*)" Class="form-control" 
                                                    AutoPostBack="True" 
                                                ...
                                                <div class="col-lg-4 text-left">
                                                  ...
                                                  <asp:Button ID="btnsave" runat="server"   data-bs-toggle="modal" data-bs-target="#exampleModal1" class="btn btn-primary"  
