<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OTOPTORegisterAdd.aspx.cs" Inherits="OTOPTORegisterAdd" %>
    ...
    <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>
            <section class="content-header d-flex">
                <h1>OPTO OT Register</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">OPTO OT Register</li>
                    </ol>
            </section>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <textarea  runat="server" style="height:30px;width:250px" id="txtdescription" cols="1"  rows="1"></textarea>        
