...
public partial class OPDvisitsforchildrenandadolescents : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        {
            query += " and    OpdRegistration.Entrydate between ('" + Convert.ToDateTime(txtFrom.Value).ToString("MM/dd/yyyy") + "') and ('" + Convert.ToDateTime(txtTo.Value).ToString("MM/dd/yyyy") + "')";
        }
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_OpdVisitChildren.rpt");
        Session["reportname"] = "Rpt_OpdVisitChildren";
