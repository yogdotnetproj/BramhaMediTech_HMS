...
using System.Media;
public partial class MYOMECTOMY_Section : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
       ...
       // ObjOCT.Notes = txtPRevLSCSComplication.Text;
        ...
        //----
        ObjOCT.Incision = ddlIncision.SelectedValue;
        ObjOCT.NumberofFibroids = txtnumberofFibroids.Text;
        ObjOCT.LocationofFibroids = txtlocationOfFibroids.Text;
        ObjOCT.Opens = ddlopen.SelectedValue;
        ObjOCT.Ovaries = ddlOvaries.SelectedValue;
        ObjOCT.Tourniquet = ddlTourniquet.SelectedValue;

        ObjOCT.Emdometrium = ddlEmdometrium.SelectedValue;
        ObjOCT.DropBox = txtdropBox.Text;
        ObjOCT.Blocked = ddlBlocked.Text;
        ObjOCT.Drilled = ddlDrilled.SelectedValue;
        ObjOCT.TubesTested = ddlTubeTested.SelectedValue;
        ObjOCT.IntraUterineFoleys = ddlIntraUterine.SelectedValue;
        ...
        ObjOCT.Insert_MYOMECTOMY_Section();
        ...
        txtInflate.Text = "";
        txtlocationOfFibroids.Text = "";
        txtmaterialforwarded.Text = "";
        txtNoteDate.Text = "";
        txtnumberofFibroids.Text = "";
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Alter_MYOMECTOMY_Section_Report(Convert.ToInt32(Session["OTRegNo"]), Convert.ToInt32(Session["OTOpdNo"]), Convert.ToInt32(Session["OTIpdNo"]));
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Report/Rpt_MYOMECTOMY_Section_Report.rpt");
        Session["reportname"] = "MYOMECTOMY_Section_Report";
