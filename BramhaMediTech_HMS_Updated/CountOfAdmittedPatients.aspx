<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="CountOfAdmittedPatients.aspx.cs" Inherits="CountOfAdmittedPatients" %>
             ...
             <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Patient Count</li>
                    </ol>
                </section>
                             ...
                             <div class="box-header">
                                 ...
                                 <div class="box-body">  
                                     ...
                                     <div class="col-sm-2">
                                          ...
                                          <div class="col-sm-2">
                                                     <div class="form-group">
                                                    <asp:Button ID="btnPrint" runat="server" onclick="btnPrint_Click" CssClass="btn btn-success"
                                            Text="Print" />
                                                         </div>
                                              </div>
