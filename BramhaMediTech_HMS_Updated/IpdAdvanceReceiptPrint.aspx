<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="IpdAdvanceReceiptPrint.aspx.cs" Inherits="IpdAdvanceReceiptPrint" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
         ...
         <ContentTemplate>
                ...
                <section class="content-header d-flex">
                    <h1>Ipd Advance Cancel Receipt Print</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Ipd Advance Cancel Receipt Print</li>
                    </ol>
                </section>
                    ...
                    <div class="box">
                                     ...
                                     <div class="panel-heading" style="font-size:medium;font-weight:bold ;background-color:#B24592" ">Patient Information:   
                                                ...
                                                <div class="form-group">
                                                 <asp:Label ID="lblIPDNo" runat="server"  Font-Bold="True">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <asp:CheckBox ID="ChkReceipt" Visible="false" Text=" Prev.Receipts"  runat="server" AutoPostBack="true" ></asp:CheckBox>
                                                  ...
                                                  <div class="col-lg-12 mt-3 mb-3" runat="server" visible="false">
                                        ...
                                        <div class="col-lg-6">
                                                  ...
                                                  <div class="col-lg-12 mt-3">
                                                        ...
                                                        <div  class="form-group">
                                                         ...
                                                         <div class="col-lg-4 text-left">
                                                                                    <div class="form-group">
                                                                                      <span>
                                                                                          <asp:RadioButtonList RepeatDirection="Horizontal" runat="server" AutoPostBack="true" ID="ReceiptType" OnSelectedIndexChanged="ReceiptType_SelectedIndexChanged">
                                                                                              <asp:ListItem  Value="1">Advance</asp:ListItem>
                                                                                              <asp:ListItem Selected="True" Value="0">Cancel</asp:ListItem>
                                                                                        </asp:RadioButtonList>
                                                                                     </span></div>
                                                                                </div>
                                            ...
                                            <div class="row"> 
                                                  ...
                                                  <div id="PaymentDetails" runat="server" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                    ...
                                    <asp:Button ID="btnsave"  class="btn btn-success" Visible="false" runat="server"  Text="Save Bill" OnClick="btnsave_Click"  />
