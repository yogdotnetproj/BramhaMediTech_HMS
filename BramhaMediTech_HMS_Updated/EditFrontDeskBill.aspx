<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="EditFrontDeskBill.aspx.cs" Inherits="EditFrontDeskBill" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
       ...
       <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Edit Front Desk Bill</h1>
                    <ol class="breadcrumb">
                        
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Edit Front Desk Bill</li>
                    </ol>
                </section>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 text-center">
                                                    ...
                                                    <div class="form-Inline form-check"> 
                                                         <asp:RadioButtonList ID="rdbgroup" Enabled="false" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rdbgroup_SelectedIndexChanged">
                                      ...
                                      <%--  <div class="col-lg-12 mt-3"> 
                                         ...
                                         <div class="col-sm-3 text-left">
                                                        <div class="form-group"> 
                                                                ...
                                                                <asp:RadioButtonList ID="rblPatcate" Enabled="false" runat="server"  RepeatDirection="Horizontal" AutoPostBack="True"  ForeColor="Red" Font-Bold="True" Font-Size="Medium" OnSelectedIndexChanged="rblPatcate_SelectedIndexChanged" >
                                         ...
                                         <div class="col-sm-5 text-left">
                                                    <div class="form-group">  
                                                             <asp:TextBox ID="ddlPatientSubCategoryName1" Enabled="false" runat="server" TabIndex="3" AutoCompleteType="None" cssclass="form-control"  placeholder="Enter  Insurance(*)"
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                <div class="col-sm-4 text-left">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="ddlChargeSubCategory1" Enabled="false" runat="server" TabIndex="3" AutoCompleteType="None" cssclass="form-control"  placeholder="Enter  Company(*)"
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                ...
                <input id="rdbdiscPer" type="radio" runat="server" name="rdbDisc" value="Per" />
                  <label for="rdbdiscPer">Per(%)</label>
                                        ...
                                        TabIndex="15" CssClass="btn btn-primary" OnClick="btnDataForm_Click"  />
