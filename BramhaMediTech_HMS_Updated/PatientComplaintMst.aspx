<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="PatientComplaintMst.aspx.cs" Inherits="PatientComplaintMst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     <script type = "text/javascript">
         function Validate() {
             ...
             if (document.getElementById("MainContent_txtComplaint").value == "") {
                 alert("Please Enter Patient Complaints");
                 return false;
             }
         }
        </script>
    ...
    <section class="content-header d-flex">
                    <h1>Patient Complaints Master</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Patient Complaints Master</li>
                    </ol>
                </section>
      ...
      <section class="content">
                            ...
                            <asp:GridView ID="gvPatComplaint" runat="server" AutoGenerateColumns="False" DataKeyNames="PatComplaintId"
                            class="table table-responsive table-sm table-bordered" Width="100%" 
                            AlternatingRowStyle-BackColor="White" HeaderStyle-ForeColor="Black" 
                            CellPadding="3" AllowPaging="True" PageSize="10"
                            OnRowDeleting="gvPatComplaint_RowDeleting" OnRowEditing="gvPatComplaint_RowEditing"
                             OnPageIndexChanging="gvPatComplaint_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PatComplaintId" HeaderText="PatComplaintId" Visible="False" />
                                <asp:BoundField DataField="PatComplaint" HeaderText="Patient Complaint"/>                         
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtComplaint">Patient Complaint:</label>                                                                                
                                                    </div>
                                         </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">                                                    
                                              
                                              <asp:TextBox ID="txtComplaint" runat="server" placeholder="Enter Patient Complaint(*)" CssClass="form-control" 
