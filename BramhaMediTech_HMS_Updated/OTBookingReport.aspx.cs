...
public partial class OTBookingReport : System.Web.UI.Page
{
    ...
    protected void FillCancelPatientRegGrid()
    {
        ...
        ViewState["ToDate"] = Convert.ToDateTime(txtToDate.Text).AddDays(1).ToString("yyyy-MM-dd");
        gvPatientInfo.DataSource = objDALPatInfo.OTBookingReport(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]), Convert.ToInt32(Session["Branchid"]));
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ObjDOReport.GetOTBookReport(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]), BranchId);

            Session.Add("rptsql", sql);
            Session["rptname"] = Server.MapPath("~/Reports/Rpt_OTBooking_Report.rpt");
            Session["reportname"] = "OTBooking_Report";
