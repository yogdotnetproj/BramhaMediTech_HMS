<%@ Page Title="" Language="C#" MasterPageFile="~/OT_mainMaster.master" AutoEventWireup="true" CodeFile="ABDOMINAL_HYSTERECTOMY_Section.aspx.cs" Inherits="ABDOMINAL_HYSTERECTOMY_Section" %>
            ...
            <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">TOTAL ABDOMINAL HYSTERECTOMY</li>
                    </ol>                
                </section>
                    ...
                    <div class="row">
                        <div class="panel-heading">
                            <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <strong>TOTAL ABDOMINAL HYSTERECTOMY</strong>
                                        </div>
                                </div>
                        </div>
                                ...
                                <div class="col-sm-4" >
                                            <div class="form-group">
                                               STANDARD TAH
                                                          ...
                                                          <div class="col-sm-4" >
                                            <div class="form-group">
                                             <asp:DropDownList ID="ddlStandardTAH"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                                <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                <asp:ListItem Value="No">No</asp:ListItem>
                                                          ...
                                                          <div class="col-sm-4" >
                                            <div class="form-group">
                                             <asp:DropDownList ID="ddlStandardTAH1"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                                <asp:ListItem Value="UNILATERAL">UNILATERAL</asp:ListItem>
                                                <asp:ListItem Value="BILATERAL">BILATERAL</asp:ListItem>
                                                  <asp:ListItem Value="OPHORECTOMY">OPHORECTOMY</asp:ListItem>
                                                ...
                                                <div class="col-lg-12 mt-2">
                                                   <strong> INTRA OP</strong>
                                                      <div class="row">
                                                         <div class="col-sm-6" >
                                            <div class="form-group">
                                              FINDINGS:UTERINE SIZE IN WEEK
                                                </div>
                                    </div>
                                                          <div class="col-sm-6" >
                                            <div class="form-group">
