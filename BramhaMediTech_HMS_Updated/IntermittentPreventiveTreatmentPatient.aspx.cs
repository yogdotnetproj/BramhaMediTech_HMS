...
public partial class IntermittentPreventiveTreatmentPatient : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (ANCExamination.IPT2='True')  ";
        if (txtFrom.Text != "" && txtTo.Text != "")
        {
            query += " and    ANCExamination.CreatedOn between ('" + Convert.ToDateTime(txtFrom.Text).ToString("MM/dd/yyyy") + "') and ('" + Convert.ToDateTime(txtTo.Text).AddDays(1).ToString("MM/dd/yyyy") + "')";
        }
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VisitForIntermittentPreventiveTreatmentPatient.rpt");
        Session["reportname"] = "Rpt_VisitForIntermittentPreventiveTreatmentPatient";
