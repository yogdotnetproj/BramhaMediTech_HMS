<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="IPDDischargeList.aspx.cs" Inherits="IPDDischargeList" %>
...
<%--    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>IPD discharge patient list</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">IPD discharge patient list</li>
                    </ol>
            </section>
                        ...
                        <div class="row">
                             ...
                             <div class="col-lg-2" >
                                ...
                                <div class="col-lg-2 text-left">
                                    <div class="form-group"> 
                                         <asp:DropDownList ID="ddlreasonofdisc" runat="server" AutoPostBack="false" Class="form-control" TabIndex="2">
                                             <asp:ListItem Value="0">--select--</asp:ListItem>
                                             <asp:ListItem Value="Recover">Recover</asp:ListItem>
                                             <asp:ListItem Value="Personal request">Personal request</asp:ListItem>
                                    ...
                                    <div class="col-sm-1 text-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnPdf"  runat="server" Text="PDF" TabIndex="3" ValidationGroup="Date" CssClass="btn btn-primary btnSearch" OnClick="btnPdf_Click" />
                                        </div>
                                            </div>
                                    </div>
                                              <div class="col-sm-1 text-left">
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnExcel" runat="server" Text="EXCEL" TabIndex="3" ValidationGroup="Date" CssClass="btn btn-warning btnSearch" OnClick="btnExcel_Click" />
                                        </div>
                                            </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="IpdId"
                                                    ...
                                                    <Columns>  
                                                         <asp:ButtonField CommandName="Select" Text="Select"  HeaderText="Select" ControlStyle-CssClass="btn btn-warning" ButtonType="Button" ItemStyle-Width="80" >                                                    
                                                        ...
                                                        <asp:ButtonField CommandName="Report" Text="Report" HeaderText="Report" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         ...
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                            ...
                                                            <asp:ButtonField CommandName="SummaryUSD" Text="Summary USD" HeaderText="Summary USD" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-danger" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="Discharge" Text="Disc summary" HeaderText="Disc Summary" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-success" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="ReAdmit" Text="ACT Open" ControlStyle-CssClass="btn btn-danger" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-danger" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
