...
public partial class Insurance_Receipt_ForIPD : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        ...
        gvDailyCash.DataSource = ObjDOReport.Fill_AllInsurancr_Receipt_IPD(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]), Convert.ToInt32(Sponser), BranchId, "0"); //Convert.ToInt32(ddlUser.SelectedValue));
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        int ReceiptNo = Convert.ToInt32(gvDailyCash.DataKeys[row.RowIndex]["ReceiptNo"]);
       ...
       // int ReceiptNo = Convert.ToInt32(ddlreceipts.SelectedValue);
        ...
        objreports.InsurancePaymentReceipts_For_IPD(ReceiptNo,Convert.ToInt32( HdnSponser.Value), FId, BranchId);
    ...
    protected void Print_Click(object sender, EventArgs e)
    {
      ...
      //  int ReceiptNo = Convert.ToInt32(ddlreceipts.SelectedValue);
        ...
        objreports.InsurancePaymentReceipts_Report_IPD(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]), Sponser, "0", BranchId);

        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Reports/Rpt_Insurance_PaymentRec.rpt");
        Session["reportname"] = "Insurance_PaymentRec";
        Session["RPTFORMAT"] = "pdf";
