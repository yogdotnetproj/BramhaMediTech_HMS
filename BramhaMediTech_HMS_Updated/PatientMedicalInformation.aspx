<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="PatientMedicalInformation.aspx.cs" Inherits="PatientMedicalInformation" %>
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
     <Triggers>
            ...
            <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Patient Medical Information</li>
                    </ol>
            ...
            <ContentTemplate>
                                <div class="box-header with-border">                           
                                    <span class="red pull-right">Fields marked with * are compulsory</span> 
                                     ...
                                     <asp:Label ID="lblRegNo" runat="server" Text="" Font-Bold="true" Font-Size="Medium" ></asp:Label>
                    ...
                    <div class="col-lg-12" runat="server" visible="false" >
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="row">                                  
                                          ...
                                          <div class="col-sm-2" >
                                            <div class="form-group">
                                                <label for="txtFirstName">Patient Name</label> 
                                                </div>
                                              </div>                                                                               
                                        ...
                                        <div class="col-sm-6" >
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtFirstName" AutoCompleteType="None" runat="server" onChange="javascript:capFirst(this);"  CssClass="form-control" placeholder="Enter Patient Name(*)"
                                                onkeyPress="return alpha_only(event);" TabIndex="2" AutoPostBack="true"
                                 ...
                                 <div class="col-sm-1"> 
                                                     <div class="form-group">
                                                          <label for="txtAge">Age</label>     
                                                           ...
                                                           <div class="form-group"> 
                                                                ...
                                                                <asp:TextBox ID="txtAge" runat="server" TabIndex="3" CssClass="form-control" placeholder="Age"
                                        ...
                                        <div class="col-lg-12 mt-3">
                                         ...
                                         <div class="col-sm-2 text-left">
                                            <div class="form-group">
                                                <label for="ddlGender">Age/Gender</label>  
                                                </div>
                                              </div>
                                               <div class="col-sm-2">                                                    
                                                    <div class="form-group">
                                                 ...
                                                 <div class="col-sm-2">
                                                    <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtMobileNo" runat="server" CssClass="form-control" placeholder="Enter Mobile No." 
                                                             onkeyPress="return numeric_only(event);" TabIndex="6" MaxLength="7"></asp:TextBox>
                                                        </div>
                                                    </div> 
                                                <div class="col-sm-2" runat="server" visible="false">
                                                    <div class="form-group">
                                            ...
                                            <asp:Button ID="btnRemoveImage" runat="server" Text="Remove" CssClass="btn btn-primary" CausesValidation="False" OnClick="btnRemoveImage_Click" />
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">                                                   
                                                          ...
                                                          <asp:TextBox ID="txtBirthDate" runat="server"   CssClass="form-control" TabIndex="7" 
                                          ...
                                          <div class="col-lg-12 mt-3"> 
                                            <div class="row"> 
                                                ...
                                                <div  class="col-sm-2">
                                                 ...
                                                 <div id="Div1"  class="col-sm-2 pr-0" runat="server">
                                                    <div class="form-group">
                                                 ...
                                                 <div  class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtEmail">Health Card No:</label>   
                                                        </div>
                                                    </div>                                                                 
                                                <div class="col-sm-2" >
                                                    <div class="form-group">
                                                        
                                                             <asp:TextBox ID="txthealthcardNo" runat="server" TabIndex="11" class="form-control" placeholder="Enter HealthCardNo"  
                                                            ></asp:TextBox>
                                                        </div>
                                                </div>                 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="txtBirthPlace" runat="server" CssClass="form-control" placeholder="Enter Birth Place"
                                                       ></asp:TextBox>
                                                 ...
                                                 <div  class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtEmail">Passport No:</label>   
                                                        </div>
                                                    </div>                                                                 
                                                <div class="col-sm-2" >
                                                    <div class="form-group">
                                                        
                                                             <asp:TextBox ID="txtpassportNo" runat="server" CssClass="form-control" placeholder="Enter Passport No"  
                                                           ></asp:TextBox>
                                                        </div>
                                                </div>  
                                        ...
                                        <div class="col-lg-12 mt-2">
                                         <div class="panel-heading" style="font-size:medium;font-weight:bold"">Relative Information: </div>
                                            </div>
                                                <div class="col-lg-12 mt-2">
                                            <div class="row">     
                                                     <div class="col-sm-2">
                                                    <div class="form-group">
                                                        <label for="txtMobileNo">Relative Name:</label>   
                                               </div>
                                                      </div>
                                         ...
                                         <div class="col-sm-1 text-left">
                                            <div class="form-group">
                                                <label for="ddlGender">Relation</label>  
                                                </div>
                                              </div>
                                               <div class="col-sm-2">                                                    
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                <label for="txtPatientAddress">Contact No:</label> 
                                                        </div>
                                                    </div>
                                         ...
                                         <div class="col-lg-12 mt-3">
                                            <div class="row">     
                                                     <div class="col-sm-2">
                                                    <div class="form-group">
                                                        <label for="txtMobileNo">Address:</label>   
                                               </div>
                                                      </div>
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                          ...
                          <div class="col-lg-12 mt-3">
                                         ...
                                         <div class="col-lg-12 mt-3"> 
                                            <div class="row">
                                                 <div class="col-sm-2">
                                                  ...
                                                  <div class="col-sm-4">
                                                    <div class="form-group">
                                                         ...
                                                         <asp:TextBox ID="txtallergy" runat="server" TextMode="MultiLine" CssClass="form-control" placeholder="Enter Allergy"
                                                            ></asp:TextBox>               
                                                 ...
                                                 <div  class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtEmail">Complant:</label>   
                                                        </div>
                                                    </div>                                                                 
                                                <div class="col-sm-4" >
                                                    <div class="form-group">
                                                        
                                                             <asp:TextBox ID="txtComplant" TextMode="MultiLine" runat="server" CssClass="form-control" placeholder="Enter Complant"  
                                                           ></asp:TextBox>
                                                        </div>
                                                </div>  
                     ...
                     <div class="box-footer">
                                    <div class="row">
                                        ...
                                        TabIndex="12" Width="80px" class="btn btn-primary"   CausesValidation="False" OnClientClick="return Validate();" />
                                           
                                             <asp:Button ID="btnOPD" runat="server" TabIndex="14" onclick="btnOPD_Click" Text="Medical Record" 
                                                 Width="180px" class="btn btn-primary"  CausesValidation="False" />
                                                <asp:Button ID="btnIPD" runat="server" TabIndex="15"  Text="IPD" 
                                                Width="80px"  class="btn btn-primary" CausesValidation="False" onclick="btnIPD_Click" />
                                        ...
                                        Text="Back" Width="80px" class="btn btn-primary" CausesValidation="False" TabIndex="17" />
        ...
        <ProgressTemplate>
        <center><img id="Img1" src="/HMSNEW_Final_US_MercyHosp_New/Images0/Progress-Bar.png" height="100" runat="server" /></center>
        </ProgressTemplate>
        </asp:UpdateProgress>
                             </div>
                                  <div class="row">
                        <%--<div class="col-lg-12 mt-3 text-center">
                            <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Width="500px">
                            <table cellspacing="0" style="border: Solid 3px #D55500;" width="100%">
                            <tr>
                            <td align="center" 
                                    style="color:White; font-weight: bold; font-size: larger; background-color:#D55500" 
                                    colspan="2">
                                 Take Patient Photo
                                </td>
                            </tr>
                                <tr>
                                    <td>
                                        ...
                                        <asp:Button ID="btnUpload" runat="server" CausesValidation="False" 
                                            CssClass="Cnter" onclick="btnUpload_Click" Style="display: none" TabIndex="10" 
                                            Text="Upload" />
                                    </td>
                                    <td>
                                        <asp:Button ID="btnWebCam" runat="server" Text="Capture From WebCam" />
                                    </td>
                                </tr>
                                <tr >
                                    <td align="center" colspan="2">
                                        <asp:Button ID="btnCancel" runat="server" CausesValidation="False" 
                                            ForeColor="Red" TabIndex="16" Text="Close" Width="70px" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                    ...
                    PopupControlID="pnlpopup" CancelControlID="btnCancel" BackgroundCssClass="modalBackground" DropShadow="true"
                     RepositionMode="None">
        ...
        <div class="modal fade" id="myModal" role="dialog">
            ...
            <script type='text/javascript'>
                ...
                //function PreventDivCollapse() {
                //    $('id*=Information').on('hide.bs.collapse', function (e) {
                //        e.preventDefault();
                //    })
                //}
                //$(document).ready(function () {
                ...
                //    // $('[id*=Information]').collapse('toggle');
