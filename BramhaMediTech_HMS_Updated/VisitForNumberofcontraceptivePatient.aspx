<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalTemp.master" AutoEventWireup="true" CodeFile="VisitForNumberofcontraceptivePatient.aspx.cs" Inherits="VisitForNumberofcontraceptivePatient" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>Visit ForNumber of contraceptive use patient</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Visit ForNumber of contraceptive use patient </li>
                    </ol>
                </section>
