...
public partial class HIVTotalPatient : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (ANCExamination.HIV='True')  ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VisitForHIVPatient.rpt");
        Session["reportname"] = "Rpt_VisitForHIVPatient";
