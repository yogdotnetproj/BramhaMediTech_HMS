...
public partial class OPDvisitsforMalechildren : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (PatientInformation.AgeType <> 'Years' OR PatientInformation.Age < 10)  and Gender.GenderName= 'Male'";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_OpdVisitMailChildren.rpt");
        Session["reportname"] = "Rpt_OpdVisitMailChildren";
