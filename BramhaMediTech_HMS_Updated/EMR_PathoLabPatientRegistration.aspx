<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="EMR_PathoLabPatientRegistration.aspx.cs" Inherits="EMR_PathoLabPatientRegistration" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Pathology Registration</h1>
                    <ol class="breadcrumb">
                       
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Pathology Registration</li>
                    </ol>
                </section>
            <section class="content">
                 ...
                 <div class="box" runat="server" id="Show">
                     ...
                     <div class="box-header with-border">
                                   ...
                                   <div class="row"> 
                                         <div id="Div28" class="col-lg-12" runat="server" > 
                                            <div class="row">
                                    <asp:Label ID="lblMessage" class="red pull-left"  runat="server" Text="" Font-Bold="true" ForeColor="green" ></asp:Label>
                          <asp:Label ID="lblVisitingNo" class="red pull-center" Visible="false"  runat="server" Text="Your Visit no is:" ></asp:Label>
                                                </div>
                                             </div>
                                       </div>
                                            ...
                                            <div class="row">
                                                    <div class="form-Inline form-check pl12">
                                                        <asp:RadioButtonList ID="RBLLabType" runat="server" Enabled="false"  BackColor="#66ccff" RepeatDirection="Horizontal" AutoPostBack="True"  Font-Bold="True" Font-Size="Medium" Width="100%" OnSelectedIndexChanged="RBLLabType_SelectedIndexChanged" >
                                                             <asp:ListItem Selected="True" Value="P" >Pathology</asp:ListItem>
                          ...
                          <div id="Div20" class="col-lg-12" runat="server"  > 
                                            <div class="row"> 
                                                </div>
                              </div>
                                        <div id="Div1" class="col-lg-12" runat="server" visible="false"> 
                                            <div class="row">
                                                ...
                                                <div id="Div2" class="col-lg-12" runat="server" visible="false"> 
                                            <div class="row">
                                                  <div class="col-lg-1">
                                         ...
                                         <div class="col-lg-3">
                                               ...
                                               <div class="col-lg-1">
                                                        <div class="form-group"> 
                                                            <label for="ddlPatientSubCategoryName">Sponser SubCategory</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div>
                                         <div class="col-lg-3">
                                                    <div class="form-group">
                                        
                                                         <asp:DropDownList ID="ddlPatientSubCategoryName" runat="server" AutoPostBack="True" TabIndex="2" CssClass="form-control form-select"
                                        ...
                                        <div id="Div3" class="col-lg-12" runat="server" visible="false" > 
                                            <div class="row">  
                                                <div class="col-lg-1">
                                                        <div class="form-group"> 
                                            ...
                                            <div class="form-group">  
                                               ...
                                               <asp:AutoCompleteExtender 
                                                ...
                                                runat="server"><%--ServicePath="~/AutoCompleteService.asmx"--%>
                                                 ...
                                                 <div id="Div4" class="col-lg-12" runat="server" visible="false" > 
                                            <div class="row">  
                                                <div class="col-lg-1">
                                                        <div class="form-group"> 
                                          ...
                                          <div id="Div6" class="col-lg-12" runat="server" visible="false"> 
                                            <div class="row">
                                                ...
                                                <div id="Div9" class="col-lg-2" runat="server">
                                                    <div class="form-group">
                                                ...
                                                <div id="refdr" visible="false" runat="server">
                                                 ...
                                                 <div class="col-lg-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="Div10" style="overflow:auto; background-color: #0000FF;" ></div>
                                     ...
                                     <asp:AutoCompleteExtender 
                                          ...
                                          CompletionListCssClass="AutoExtender"
                                            ...
                                            TabIndex="19" ></asp:TextBox>
                                                 ...
                                                 <div id="Div11" class="col-lg-2 text-left" runat="server" visible="false">
                                                    <div class="form-group">
                                                           
                                                        <asp:TextBox ID="txtReferanceDrText" runat="server" class="form-control"    placeholder="Enter Ref. Dr"
                                         ...
                                         <div class="col-lg-12 mt-3"> 
                                            <div class="row"> 
                                                <div class="col-lg-6">
                                                  <div id="AddTest" runat="server">
                                                     
                                                           
                                             <div class="row">
                                           <div class="col-lg-12">  <label for="ggfdgfd">Add Test: </label>  </div>
                                            <div class="col-lg-12"> 
                                    ...
                                    <div class="col-lg-6">
                                              <div class="form-group"> 
                                                   <asp:TextBox ID="txtCharges" runat="server"  onkeyPress="return numeric_only(event);"
                                                        class="form-control" AutoPostBack="true" placeholder=" Charges" TabIndex="15" OnTextChanged="txtCharges_TextChanged" Font-Bold="True" Font-Size="Medium"></asp:TextBox>                    
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtTotalCharges"  runat="server" readonly="true" onkeyPress="return numeric_only(event);"
                                                        class="form-control"  TabIndex="130" Font-Bold="True"></asp:TextBox>                    
                                                           ...
                                                           <div class="col-lg-12 mt-3">
                                              <div class="form-group"> 
                                                      <asp:TextBox ID="txtclinicalHistory" runat="server"  
                                                        AutoPostBack="false" CssClass="form-control" TextMode="MultiLine" placeholder=" Clinical History" TabIndex="15"  Font-Bold="True" Font-Size="Medium" ></asp:TextBox>                    
                                                           
                                                  </div>
                                                               </div>
                                                            <div class="col-lg-12 mt-3 " runat="server" id="WardShow" visible="false">
                                                          <div class="row">
                                                               <div id="Div29" class="col-lg-8" runat="server" >
                                              <div class="form-group">
                                                  <asp:TextBox ID="txtverbalby" runat="server"  
                                                        AutoPostBack="false"   CssClass="form-control" placeholder=" Verbal order by" Font-Bold="True" Font-Size="Medium" ></asp:TextBox>                    
                                                         
                                                  </div>
                                                                   </div>
                                                           <div id="Div8" class="col-lg-4" runat="server" >
                                              <div class="form-group"> 
                                                  <asp:DropDownList runat="server"  Visible="false" CssClass="form-control form-select"  ID="ddlWardName"></asp:DropDownList>
                                                  </div>
                                                               </div>
                                                              
                                                         </div>
                                                                   </div>
                                                           <div id="Div30" class="col-lg-12 mt-3 " runat="server" >
                                                          <div class="row">
                                                           <div id="Div31" class="col-lg-12" runat="server" >
                                              <div class="form-group">
                                                   <asp:TextBox ID="txtverbalon" runat="server"  
                                                        AutoPostBack="false"   CssClass="form-control" placeholder=" Verbal order on" Font-Bold="True" Font-Size="Medium" ></asp:TextBox>                    
                                                 
                                                  </div>
                                                               </div>
                                                              </div>
                                                               </div>
                                                           <div id="Div7" class="col-lg-2" runat="server" visible="false">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group"> 
                                                 ...
                                                 <div class="col-lg-1" id="space" runat="server">
                                                      <div class="row">
                                                          </div>
                                                    </div>-->
                                                 ...
                                                 <div runat="server" id="Div18" style="height:250px;  overflow:scroll"  >                                          
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                              ...
                              <FooterStyle BackColor="White" ForeColor="#000066" />
                                                ...
                                                <SortedDescendingHeaderStyle BackColor="#00547E" />
                                                    ...
                                                    <asp:Button ID="btnnotedetails" Visible="false" runat="server" Text="Details" />
                                                         <div class="col-lg-12 mt-3 text-center" runat="server" id ="savebill">
                                                               <asp:CheckBox ID="chkIsEmergency" Checked="true" CssClass="BigCheckBox" Font-Bold="true" ForeColor="Red" Text="Emergency" runat="server" />
                                        ...
                                        TabIndex="15" Width="120px" class="btn btn-success"  />
                                    ...
                                    <asp:Button ID="btnReset" runat="server" Text="Reset" OnClick="btnReset_Click" 
                                        ...
                                        TabIndex="15" Width="120px" class="btn btn-primary" OnClick="btnreport_Click"  />
                                          ...
                                          <div id="Div12"  runat="server" visible="false" style="width:500px">
                                                    <div id="Div13" class="row" runat="server" visible="false">
                                               ...
                                               <asp:AutoCompleteExtender 
                                                ...
                                                runat="server"><%--ServicePath="~/AutoCompleteService.asmx"--%>
                                                 ...
                                                 <div id="Div16" class="col-lg-0 text-left" style="width:140px" runat="server" visible="false" >
                                                        <div class="form-group"> 
                                                            <label for="hhdg" style="text-align:left">Consultant</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div> 
                                                <div id="Div19" class="col-lg-0 text-left"  style="width:250px" runat="server" visible="false">
                                                            <div class="form-group">                                                                                           
                                          ...
                                          <div id="Div14" class="col-lg-12" runat="server" visible="false"> 
                                            <div class="row">
                                                 <div class="col-lg-2 text-left" style="width:140px">
                                                        <div class="form-group"> 
                                                            <label for="ggfdgfd" style="text-align:left">Ref phy</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div> 
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                runat="server"><%--ServicePath="~/AutoCompleteService.asmx"--%>
                                                 ...
                                                 <div class="col-lg-2 text-left" style="width:140px">
                                                        <div class="form-group"> 
                                                            <label for="ggfdgfd" style="text-align:left">Main Dr</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div> 
                                                <div class="col-lg-2 text-left">
                                                    <div class="form-group">     
                                                        
                                                           <asp:DropDownList ID="DdlMainDoctor" runat="server" class="form-control" ></asp:DropDownList>
                                              
                                                    </div>
                                                </div>
                                                 <div class="col-lg-2 text-left" style="width:140px">
                                                        <div class="form-group"> 
                                                            <label for="ggfdgfd" style="text-align:left">Other Ref Doctor</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div> 
                                                   <div class="col-lg-2 text-left">
                                                    <div class="form-group">     
                                          ...
                                          <div id="Div15" class="col-lg-12" runat="server" visible="false" >  
                                             <div class="row">                               
                                     <label>Group Name</label>
                                            <div id="Div17" class="row" runat ="server" visible="false">
                                          ...
                                          <div class="row">
                                              ...
                                              <div id="Div21" class="col-lg-1 text-left" style="width:110px" runat="server" visible="false">
                                                    <div class="form-group">     
                               ...
                               <div class="box-body">
                                        ...
                                        <div class="col-lg-12" runat="server" id="Bill">                                            
                                        ...
                                        <div class="table-responsive" style="width:100%" >
                                             <div style=" overflow: scroll; width: 100%; height: 400px; text-align: left"
                                                ...
                                                BackColor="White"  BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"  ShowHeaderWhenEmpty="True" OnDataBound="GvNoteIngrid_DataBound"  OnRowDataBound="GvNoteIngrid_RowDataBound"  >
                                                <Columns>
                                        ...
                                        <div id="Div23" class="col-lg-12" runat="server" visible="false">                                            
                                            <div class="row"> 
                      ...
                      <asp:RadioButtonList ID="rdblInsuranceAmt" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdblInsuranceAmt_SelectedIndexChanged" >
                          ...
                          <asp:ListItem Value="1">Per(%)</asp:ListItem>
                                        ...
                                        <div id="Div24" class="col-lg-12" runat="server" visible="false">                                            
                                                   <div class="row"> 
                ...
                <input id="rdbdiscPer" type="radio" runat="server" name="rdbDisc" value="Per" />
                  <label for="rdbdiscPer">Per(%)</label>
                                        ...
                                        <div id="Div25" class="col-lg-12" runat="server" visible="false">     
                                                     <div class="row">
                                        ...
                                        <div id="Div26" class="col-lg-12" runat="server" visible="false">    
                                                    <div class="row">
                                        ...
                                        <div id="Div27" class="col-lg-12" runat="server" visible="false">  
                                                    <div class="row">
