<%@ Page Title="" Language="C#" MasterPageFile="Hospital.master"
    AutoEventWireup="true" CodeFile="InsuranceCompany.aspx.cs" Inherits="InsuranceCompany" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Maincontent" runat="Server">
     <script type = "text/javascript">
         function Validate() {

             if (document.getElementById("MainContent_txtInsuranceCompanyName").value == "") {
                 alert("Please Enter Company Name");
                 return false;
             } 
             if (document.getElementById("MainContent_txtInsuranceCompanyAddress").value == "") {
        ...
        <ContentTemplate>
            ...
            <section class="content">
                          ...
                          <asp:Button ID="btnaddnew" runat="server" class="btn btn-primary pull-right" 
                            ...
                            <asp:GridView ID="gvInsuranceCompany" runat="server" AutoGenerateColumns="False"
                            DataKeyNames="InsuranceCompanyId" OnRowDeleting="gvInsuranceCompany_RowDeleting"
                            OnRowEditing="gvInsuranceCompany_RowEditing"  CellPadding="3" 
                             class="table table-responsive table-sm table-bordered" Width="100%" 
                            AlternatingRowStyle-BackColor="White" HeaderStyle-ForeColor="Black" 
                            AllowPaging="True" onpageindexchanging="gvInsuranceCompany_PageIndexChanging" 
                            PageSize="25" TabIndex="17" ShowHeaderWhenEmpty="True">
                            <Columns>
                               
                                <asp:BoundField DataField="InsuranceCompanyId" HeaderText="Insurance Company Id"
                                    Visible="False" />
                                <asp:BoundField DataField="InsuranceCompanyName" HeaderText="Company Name" ItemStyle-HorizontalAlign="Left">
                                    <ItemStyle HorizontalAlign="Left" Width="300px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="InsuranceCompanyAddress" HeaderText="Address" ItemStyle-HorizontalAlign="Left">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                                    <div class="form-group">
                                                         <label for="txtInsuranceCompanyName">Insurance Companye:</label>                                                                                
                                                    </div>
                                         </div>
                                        <div class="col-sm-8">                                            
                                            <div class="form-group">
                                                                                            
                                                <asp:TextBox ID="txtInsuranceCompanyName" runat="server" CssClass="form-control" Placeholder="Insurance Company Name(*)" height="30px"
                                                 AutoPostBack="True" OnTextChanged="txtInsuranceCompanyName_TextChanged" 
                                        ...
                                        <div class="col-sm-8">                                                                                            
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                         <label for="txtInsuranceCompanyAddress">Insurance Companye:</label>                                                                                
                                                    </div>
                                         </div>
                                                 <div class="col-sm-8">                                            
                                            <div class="form-group"> 
                                                     
                                                 <asp:TextBox ID="txtInsuranceCompanyAddress" runat="server" AutoPostBack="True"  Height="30px"
                                                TextMode="MultiLine" TabIndex="2" class="form-control" Placeholder="Insu.Company Address(*)" ></asp:TextBox>
                                        ...
                                        <div class="col-sm-8">                                            
                                           ...
                                           <div class="row mb-3">                                               
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                         <label for="ddlStateName" style="text-align:left">State:</label>                                                                                
                                                    </div>
                                                </div>                                              
                                                   <div class="col-sm-8">
                                                        <div class="form-group">
                                                 ...
                                                 <div class="col-sm-4">
                                                  ...
                                                  <div class="col-sm-8">
                                                       <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtNotes" runat="server" AutoPostBack="True"  TextMode="MultiLine" Class="form-control"
                                                ...
                                                <div class="col-sm-4">
                                                   ...
                                                   <div class="col-sm-8">
                                                       <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtPostalCode" runat="server" AutoPostBack="True" Class="form-control"
