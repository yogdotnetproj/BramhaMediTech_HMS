<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="PatientInvoiceSubCategory.aspx.cs" Inherits="PatientInvoiceSubCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <section class="content-header d-flex">
                    <h1>Insurance Child Company</h1>
                    <ol class="breadcrumb">
                         <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Insurance Child Company</li>
                    </ol>
                </section>
    <section class="content">
                   ...
                   <asp:DropDownList ID="ddlpatmaincat" runat="server" AutoPostBack="True"
                                    ...
                                    <div class="form-group">
                                         <label for="txtPatientSubCat">Insurance Company:</label>                                                                                
                                        </div>
                                    </div>
                                                <div class="col-sm-4">
                                    <div class="form-group"> 
                                         <asp:DropDownList ID="ddlRateType" runat="server" cssclass="form-control form-select" AutoPostBack="True" OnSelectedIndexChanged="ddlRateType_SelectedIndexChanged">                                                 
                                                </asp:DropDownList>
                              ...
                              <div class="row mb-3">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                         <label for="ddlpatmaincat">Child Insurance:</label>                                                                                
                                        </div>
                                    </div>
                                  <div class="col-sm-3">
                                    <div class="form-group">                                     
                                         ...
                                         <asp:TextBox ID="txtPatientSubCat"  runat="server" placeholder="Enter Child Insurance(*)" class="form-control" AutoPostBack="True" OnTextChanged="txtPatientSubCat_TextChanged" ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                         <label for="txtPatientSubCat">Contact Number:</label>                                                                                
                                                ...
                                                <div class="col-sm-4">
                                    <div class="form-group"> 
                                       <asp:TextBox ID="txtContactNumber"  runat="server" placeholder="Enter Contact Number(*)" class="form-control" ></asp:TextBox>
                            ...
                            <div class="row mb-8">
                                                 <div class="col-sm-2">
                                      <div class="form-group">
                                         <label for="ddlRateType" style="text-align:left">Description:</label>                                                                                
                                      </div>
                                  </div>                               
                                       
                                                   <div class="col-sm-5">
                                            <div class="form-group"> 
                                               <asp:TextBox ID="txtDescription" runat="server" Height="150px" TextMode="MultiLine" placeholder="Description" CssClass="form-control" ></asp:TextBox>
                                            </div>
                                        </div>     
                    ...
                    AlternatingRowStyle-BackColor="White">
                      <AlternatingRowStyle BackColor="#95deff"></AlternatingRowStyle>
                       <Columns>
                           ...
                           <asp:BoundField DataField="PatientInsuType" HeaderText=" Insurance Company" 
                                    ItemStyle-HorizontalAlign="Left">
                                <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="ChildCompanyName" HeaderText="Sub Insurance Company" 
                                    ItemStyle-HorizontalAlign="Left">
                                <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:BoundField>
                           <asp:BoundField DataField="ContactNumber" HeaderText="Cont No" 
                                    ItemStyle-HorizontalAlign="Left">
                               
                                </asp:BoundField>
                               
                           <asp:BoundField DataField="CompanyDescription" HeaderText="Note" 
                                    ItemStyle-HorizontalAlign="Left">
                                <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:BoundField>
