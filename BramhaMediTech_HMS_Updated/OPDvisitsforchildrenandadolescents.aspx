<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OPDvisitsforchildrenandadolescents.aspx.cs" Inherits="OPDvisitsforchildrenandadolescents" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>OPD visits for children and Adolescents</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">OPD visits for children and Adolescents</li>
                    </ol>
                </section>
