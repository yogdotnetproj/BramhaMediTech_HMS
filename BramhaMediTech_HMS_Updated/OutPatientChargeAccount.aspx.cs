...
public partial class OutPatientChargeAccount : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ObjDOReport.Get_OutPatientCharge_AccountReport(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]));

            Session.Add("rptsql", sql);
            Session["rptname"] = Server.MapPath("~/Reports/Rpt_OutPatientChargeAccountReport.rpt");
            Session["reportname"] = "Rpt_OutPatientChargeAccountReport";
