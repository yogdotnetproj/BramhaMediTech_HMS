<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="EMR_Lab_Test.aspx.cs" Inherits="EMR_Lab_Test" %>
             ...
             <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">EMR Lab Test</li>
                    </ol>
                </section>
                                    ...
                                    <div class="form-Inline form-check"> 
                                         ...
                                         <div class="col-sm-4" runat="server" visible="false">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlUser" runat="server"  TabIndex="2" Class="form-control form-check" />                                                      
                                                </div>                                                    
                                    </div>
                                     </div>
                                     </div>
...
<FooterStyle ForeColor="Black"></FooterStyle>
                            ...
                            <asp:BoundField DataField="CancelBill" HeaderText="Status"></asp:BoundField>
                               ...
                               <asp:BoundField DataField="ReferBy" HeaderText="ReferBy"/>
                                      <asp:BoundField DataField="ClinicalHistory" HeaderText="Clinical History"/>
                                     <asp:BoundField DataField="RegistratonDateTime" HeaderText="Enter On"/>
