...
public partial class DepartmentMaster :BasePage
{
    ...
    {
        gvDepartment.DataSource = objDALDept.FillGridDepartment();
        ...
        if (!(txtDepartmentName.Text.Equals(string.Empty)))
        {
            if (Convert.ToInt32(ViewState["DepartmentID"]) > 0)
            {
                ...
                objBELDept.DeptId = Convert.ToInt32(ViewState["DepartmentID"]);
                    ...
                    Message = objDALDept.UpdateDepartment(objBELDept);
            ...
            else
            {
                ...
                Message = objDALDept.InsertDeparment(objBELDept);
            }
    ...
    protected void gvDepartment_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            string DepartmentID = (gvDepartment.DataKeys[e.NewEditIndex]["DeptId"].ToString());
