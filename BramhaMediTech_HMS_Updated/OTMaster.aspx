<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OTMaster.aspx.cs" Inherits="OTMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">OT Master</li>
                    </ol>
                </section>
      ...
      <section class="content">
                            ...
                            <asp:GridView ID="gvOT" runat="server" AutoGenerateColumns="False" DataKeyNames="OTId"
                            class="table table-responsive table-sm table-bordered" Width="100%" 
                            AlternatingRowStyle-BackColor="White" HeaderStyle-ForeColor="Black" 
                            CellPadding="3" AllowPaging="True" PageSize="10"
                            OnRowDeleting="gvOT_RowDeleting" OnRowEditing="gvOT_RowEditing"
                             OnPageIndexChanging="gvOT_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="OTId" HeaderText="RatType Id" Visible="False" />
                                <asp:BoundField DataField="OTType" HeaderText="Rate Type"/>                         
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtOTType">Operation Theater:</label>                                                                                
                                                    </div>
                                         </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">                                                    
                                              
                                              <asp:TextBox ID="txtOTType" runat="server" placeholder="Enter Operation Theater(*)" CssClass="form-control" 
