...
public partial class VisitForAltrasoundScanPatient : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and ANCExamination.UltrasoundScan='True'  ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VisitForAltrasoundscanPatient.rpt");
        Session["reportname"] = "Rpt_VisitForAltrasoundscanPatient";
