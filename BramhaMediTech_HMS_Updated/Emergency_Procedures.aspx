<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="Emergency_Procedures.aspx.cs" Inherits="Emergency_Procedures" %>
  ...
  .BigCheckBox input {width:20px; height:20px;}
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnCasePaper" />
             <asp:PostBackTrigger ControlID="btnDataForm" />
        </Triggers>
       <ContentTemplate>
            ...
            <section class="content">
                 ...
                 <div class="box" runat="server" id="Show">
                     ...
                     <div class="box-header with-border">
                          ...
                          <asp:Label ID="lblVisitingNo" class="red pull-right"  runat="server" Font-Bold="True" ForeColor="Red" Font-Size="Larger"  ></asp:Label>
                          
                                </div>
                    
                               <div class="box-body">
                                    <div class="row"> 
                                        <div class="col-lg-12 mt-3" runat="server" id="RegRemark" visible="false"> 
                                            <div class="row">
                                                
                                         <div class="col-sm-12 text-left">
                                                        <div class="form-group"> 
                                                             <asp:Label ID="lblRemarks" class="red pull-left"  runat="server" Text="" Font-Bold="true" ForeColor="Red" ></asp:Label>
                                                            </div>
                                             </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 text-center">
                                                    ...
                                                    <div class="form-Inline form-check"> 
                                                         <asp:RadioButtonList ID="rdbgroup" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rdbgroup_SelectedIndexChanged">
                                                             ...
                                                             <asp:ListItem Value="21" Selected="True">EMERGENCY</asp:ListItem>
                                      ...
                                      <%--  <div class="col-lg-12 mt-3"> 
                                        ...
                                        <div class="col-lg-12 mt-3" runat="server" visible="false"> 
                                                ...
                                                <div class="col-sm-2 text-left">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">                                                            
                                                          <asp:TextBox ID="txtBirthDate" runat="server"   TabIndex="12" CssClass="form-control"
                                            ...
                                            <div class="row">  
                                                ...
                                                <div id="Div2" class="col-sm-8  text-left" runat="server">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12 mt-3"> 
                                         ...
                                         <asp:TextBox ID="txtDoctorName" CssClass="form-control" Placeholder="Enter Reference Doctor"   runat="server" AutoCompleteType="None" AutoPostBack="True"
                                     ...
                                     <asp:AutoCompleteExtender 
                                       ...
                                       <div class="col-lg-12 mt-2"> 
                                            <div class="row">
                                                 <div class="col-sm-12 text-left">
                                                        <div class="form-group"> 
                                                             <asp:Label ID="lblLastvisitno" class="red pull-left"  runat="server" Text="" Font-Bold="true" Font-Italic="true" ForeColor="red" ></asp:Label>
                                                            </div>
                                                     </div>
                                                </div>
                                           </div>
                                    ...
                                    <div class="row">
                                               ...
                                               <%-- <div class="col-sm-2 text-left" style="width:250px"">
                                                    <div class="form-group">                                                              
                                    ...
                                    <asp:TextBox ID="txtService" runat="server" AutoCompleteType="None"  CssClass="form-control" placeholder="Enter Service Name(*)"
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                <div class="col-sm-2 text-left">
                                                    <div class="form-group">  
                                                        ...
                                                        CssClass="form-control" AutoPostBack="true" placeholder="Enter Charges" TabIndex="13" OnTextChanged="txtCharges_TextChanged" Font-Bold="True" Font-Size="Medium"></asp:TextBox>                    
                                        ...
                                        <div class="col-sm-1 text-left">
                                                    <div class="form-group">  
                                                        ...
                                                        CssClass="form-control" placeholder="Enter Qty" TQabIndex="13" OnTextChanged="txtQty_TextChanged" Font-Bold="True" Font-Size="Medium"></asp:TextBox>                    
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                            ...
                            <SortedDescendingHeaderStyle BackColor="#00547E" />
                                        ...
                                        <div class="table-responsive" style="width:100%;height:150px" >
                                               <asp:GridView ID="GVPAstHistory" runat="server" AutoGenerateColumns="False" 
                                ...
                                ShowFooter="True" PageSize="500">
                                 <FooterStyle Font-Bold="true" BackColor="#61A6F8" ForeColor="black" />
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                            <Columns>                                
                                    <asp:BoundField DataField="DrName" HeaderText="Consultant Dr"  > 
                               ...
                               <asp:BoundField DataField="ServiceName" HeaderText="Service"  >  
                                 ...
                                 <asp:BoundField DataField="RegistratonDateTime" HeaderText="Service on"  >  
                                    
                                </asp:BoundField>
                                 <asp:BoundField DataField="PatientInsuType" HeaderText="Company"  >  
                                    
                                </asp:BoundField>
                                 <asp:BoundField DataField="LetterNo" HeaderText="Letter no"  >  
                                    
                                </asp:BoundField>
                                <asp:BoundField DataField="Details" HeaderText="Child Comp"  >  
                                    
                                </asp:BoundField>
                                 <asp:BoundField DataField="ChargeNumber" HeaderText="ChargeNo"  >  
                  ...
                  <label for="rdbdiscPer">Per(%)</label>
                                        ...
                                        <div class="col-lg-12 mt-3">  
                                          ...
                                          <div class="col-lg-3">
                                              ...
                                              <asp:TextBox runat="server" class="form-control" ID="txtcompdes" ForeColor="Red" Font-Bold="true" TextMode="MultiLine"  cols="4" rows="6" style="width:100%;"> </asp:TextBox>
                                          </div>
                                      </div>
                                       </div>
                                         <div class="col-lg-12 mt-3">  
                                                    <div class="row">
                                                        <div class="col-sm-3 text-center" runat="server" visible="false">
                                                           <div class="form-group"> 
                                                                 <asp:CheckBox ID="ChkDeposite" CssClass="BigCheckBox" AutoPostBack="true" ForeColor="Red" Font-Bold="true" runat="server"  Text="&nbsp;Transfer From Deposit"  />
                                                         ...
                                                         <asp:Label ID="lblDepositAmt" ForeColor="Red" runat="server" Font-Bold="True" Font-Size="Small"></asp:Label>
                                                              ...
                                                              <asp:Label ID="Label1" CssClass="red pull-left"  runat="server" Text="" Font-Bold="true" ForeColor="red" ></asp:Label>
                                                         </div>
                                                           
                                         <div class="col-sm-4 text-center">
                                              <div class="form-group">
                                              <asp:Label ID="lblvalidate" CssClass="red pull-left"  runat="server" Text="" Font-Bold="true" ForeColor="red" ></asp:Label>
                                            <asp:Button ID="btnsave" runat="server" Text="Save"  OnClick="btnSave_Click"  UseSubmitBehavior="false" OnClientClick="this.disabled='true';this.Value='Please Wait...';"
                                        TabIndex="15" CssClass="btn btn-success"  />

                                              <asp:Button ID="btnCasePaper" Visible="false" runat="server" Text="Case Paper"   UseSubmitBehavior="false" onclientclick="target = '_blank';" 
                                        TabIndex="15" CssClass="btn btn-primary" OnClick="btnCasePaper_Click"  />

                                              <asp:Button ID="btnDataForm" Visible="false" runat="server" Text="Data Form"    UseSubmitBehavior="false" OnClientClick="this.disabled='true';this.Value='Please Wait...';"
                                        TabIndex="15" CssClass="btn btn-warning" OnClick="btnDataForm_Click"  />

                                    <asp:Button ID="btnReset" runat="server" Text="Reset" OnClick="btnReset_Click" 
                                        CausesValidation="False" TabIndex="16" CssClass="btn btn-primary"/>
                                  </div>
                                    </div>
                                                         <div class="col-sm-2 text-center" runat="server" visible="false" >
                                                           <div class="form-group"> 
                                                                 <asp:CheckBox ID="ChkPayforCash" CssClass="BigCheckBox" AutoPostBack="true" ForeColor="Red" Font-Bold="true" runat="server"  Text="&nbsp;Pay For Cashier" OnCheckedChanged="ChkPayforCash_CheckedChanged" />
                        ...
                        <div class="row">
                            <div class="table-responsive" style="width: 100%">
                                <asp:GridView ID="gvTempTable" runat="server" AutoGenerateColumns="False" AutoPostBack="false"
                                    class="table table-responsive table-sm table-bordered" Width="100%" DataKeyNames="ProcedureServiceId"
                                    ...
                                    BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" PageSize="20" ShowHeaderWhenEmpty="True" OnPageIndexChanging="gvTempTable_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ServiceName" HeaderText="Service Name" />
                                            <asp:BoundField DataField="Qty" HeaderText="Qty" />
                                       <asp:BoundField DataField="CreatedBy" HeaderText="Given By" />
                                      
                                         <asp:BoundField DataField="CreatedOn" HeaderText="Given On" />
