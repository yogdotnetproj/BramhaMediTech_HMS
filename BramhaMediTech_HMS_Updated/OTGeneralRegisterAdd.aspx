<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OTGeneralRegisterAdd.aspx.cs" Inherits="OTGeneralRegisterAdd" %>
...
<%--    <script src="Scripts/1.3.2.min.js"  type="text/javascript"/>
   <script src="Scripts/1.7.1.custom.js" type="text/javascript"/>--%>
    ...
    <asp:UpdatePanel runat="server">
      ...
      <div class="panel-heading" style="font-size:medium;font-weight:bold"">OT Details</div>
      <div class="panel-body">
                             ...
                             <div class="row"> 
                                  ...
                                  <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txt2stAsst" runat="server" AutoPostBack="true"  CssClass="form-control" placeholder="Enter Surgeon Asst." OnTextChanged="txt2stAsst_TextChanged"></asp:TextBox>        
                                                       <%-- <asp:AutoCompleteExtender 
                                                MinimumPrefixLength="1"  
                                                ServiceMethod="SearchAsst"                                                
                                                CompletionInterval="100"
                         ...
                         <div class="col-lg-12 mt-3">
                             <div class="row"> 
                               ...
                               <div class="col-lg-3 text-left" >
                                                    <div class="form-group"> 
                                                        <asp:TextBox ID="txtswabFirstNurse" runat="server"  CssClass="form-control" placeholder="Enter First Swab Nurse" AutoPostBack="True" OnTextChanged="txtswabFirstNurse_TextChanged" ></asp:TextBox>        
                                                         <asp:AutoCompleteExtender 
                                                MinimumPrefixLength="1"  
                                                ServiceMethod="Search1stAsst"                                                
                                                CompletionInterval="100"
                                            ...
                                            CompletionListItemCssClass="AutoExtenderList"
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight" 
                                                TargetControlID="txtswabFirstNurse"
                     ...
                     <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">                                                            
                                    ...
                                    <div class="col-lg-1 text-left">
                                                    <div class="form-group">  
                                                       ...
                                                       Font-Bold="True"  AutoPostBack="True" OnTextChanged="txttimeEnd_TextChanged"></asp:TextBox>  
                                                        </div>
                                        </div>
                                    <div class="col-lg-1 text-left">
                                                    <div class="form-group">  
                                                                                         
                                                         <asp:TextBox ID="txtTTime" runat="server" CssClass="form-control" placeholder="EnterAnaest Time Hrs/Min."></asp:TextBox>        
                                 ...
                                 <div class="col-lg-1 text-left">
                                                    <div class="form-group">  
                                                          <asp:DropDownList ID="ddlASA" runat="server"   Class="form-control form-select" >                                                      
                                  ...
                                  <div class="col-lg-1 text-left">
                                                    <div class="form-group">  
                                                          <asp:DropDownList ID="DdlClass" runat="server"   Class="form-control form-select" >                                                      
                                  ...
                                  <div class="col-lg-1 p-0" >
                                                    <div class="form-group">  
                                                          <asp:Button ID="btnRegister" runat="server" CssClass="btn btn-primary" OnClientClick="return Validate();"  Text="Register" OnClick="btnRegister_Click" />
                                                        </div>
                                      </div>
                                 </div>
                              </div>
                             ...
                             <div class="row"> 
                                   <div class="col-lg-2 text-left" >
                                                    <div class="form-group">  
                                                     ...
                                                     <%--  <input type="text" value="9/23/2009" style="width: 100px;" readonly="readonly" name="Date" id="Date" class="hasDatepicker"/>--%>
                  <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">                                                            
                                                          <asp:TextBox ID="txtOtRegDate" runat="server" class="form-control"  placeholder="Enter Time Start"    
                                                             Width="100px" AutoPostBack="True"></asp:TextBox>
                                   ...
                                   <div class="col-lg-1 text-left" >
                                                    <div class="form-group">  
                                                        ...
                                                        <asp:TextBox ID="txtOtRegTime" runat="server"  class="form-control" 
                                                       Font-Bold="True"></asp:TextBox>  
                                                        </div>
                                       </div>
                                  <div class="col-lg-2 text-left" >
                     ...
                     <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">                                                            
                                                          <asp:TextBox ID="txtOtRegDate1"   runat="server" class="form-control"  placeholder="Enter Time End"    
                                                              AutoPostBack="True"></asp:TextBox>
                                    ...
                                    <div class="col-lg-1 text-left">
                                                    <div class="form-group">  
                                                        ...
                                                        <asp:TextBox ID="txtOtRegTimeFrom" runat="server"  class="form-control" 
                                                       Font-Bold="True"  AutoPostBack="True" OnTextChanged="txtOtRegTimeFrom_TextChanged"></asp:TextBox>  
                                                        </div>
                                        </div>
                                    <div class="col-lg-2 text-left">
                                                    <div class="form-group">  
                                                                                         
                                                         <asp:TextBox ID="txtTotOTTime" runat="server" CssClass="form-control" placeholder="EnterOT Time Hrs/Min."></asp:TextBox>        
                                  ...
                                  <div class="col-lg-1 text-left">
                                                    <div class="form-group">  
                                                          <asp:DropDownList ID="ddlOtGrade" runat="server"  AutoPostBack="false"   Class="form-control form-select" OnSelectedIndexChanged="ddlOtGrade_SelectedIndexChanged" >                                                      
                                  ...
                                  <div class="col-lg-2 text-left">
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txtOTRemark" runat="server" CssClass="form-control" placeholder="Enter Remark"></asp:TextBox>        
                                  ...
                                  <div class="col-lg-1 p-0" >
                                                    <div class="form-group">  
                                                          <asp:Button ID="btnAddOT" runat="server" CssClass="btn btn-success" OnClientClick="return Validate();"  Text="Add" OnClick="btnAddOT_Click" />
                                                        </div>
                                      </div>
                                 </div>
                              </div>
                                ...
                                <div class="col-lg-4 text-left">
                                                    ...
                                                    <div class="form-Inline form-check"> 
                                                         <asp:RadioButtonList ID="RdbServicesFlag" runat="server" Font-Bold="true" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RdbServicesFlag_SelectedIndexChanged" >
                                                             ...
                                                             <asp:ListItem Selected="True" Value="Other">OT</asp:ListItem>
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                <div class="col-lg-2 text-left">
                                                    <div class="form-group">  
                                                        ...
                                                        class="form-control" placeholder=" Charges" TabIndex="13"></asp:TextBox>                    
