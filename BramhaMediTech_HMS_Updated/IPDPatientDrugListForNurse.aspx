<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="IPDPatientDrugListForNurse.aspx.cs" Inherits="IPDPatientDrugListForNurse" %>
 ...
 <%--   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js" type="text/javascript"></script>--%>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <section class="content-header d-flex">
                    <h1>IPD Patient Drug List For Nurse</h1>
                    <ol class="breadcrumb">
                     ...
                     --%>   <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">IPD Patient Drug List For Nurse</li>
                    </ol>
                </section>
                ...
                <asp:Label ID="lblMsg" class="red pull-center" runat="server" Text="" Font-Bold="true" ForeColor="green"></asp:Label>
                        ...
                        <div class="box-body">
                            <div class="row mb-3">                               
                                 ...
                                 <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="input-group date" data-date-format="dd/mm/yyyy"  runat="server" id="datepicker1" data-provide="datepicker" >
                                                           <asp:TextBox id="txtFromDate" class="form-control" type="text" runat="server" autopostback="true" placeholder="Enter From Date" /> 
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="input-group date" data-date-format="dd/mm/yyyy"  runat="server" id="Div1" data-provide="datepicker" >
                                                           <asp:TextBox id="txtToDate" class="form-control" type="text" runat="server" autopostback="true" placeholder="Enter To Date" /> 
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group"> 
                                       ...
                                       <%-- <asp:RequiredFieldValidator ID="RFVsupp" ControlToValidate="txtSupplier" ForeColor="Red" runat="server" ErrorMessage="Enter"></asp:RequiredFieldValidator>--%>
                                        ...
                                        CompletionInterval="10" ID="AutoCompleteExtender1" FirstRowSelected="false" TargetControlID="txtSupplier" runat="server"></cc1:AutoCompleteExtender>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                          <asp:TextBox ID="txtPurchaseOrderNo" runat="server" AutoPostBack="True"  placeholder="Enter IPD No." CssClass="form-control" ></asp:TextBox>
                                        </div>
                                    </div>
                            ...
                            <div class="row mb-3">  
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        CompletionInterval="10" ID="AutoCompleteExtender2" FirstRowSelected="false" TargetControlID="txtdrname" runat="server"></cc1:AutoCompleteExtender>
    ...
    <asp:ListItem Value="2" >All</asp:ListItem>
                        ...
                        <div class="box-body">
                           <div class="table-responsive" style="width:100%">  
                            ...
                            <asp:GridView ID="gvPurchaseList"  DataKeyNames="TreatmentId,Ipd,PatientRegId" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TreatmentId" HeaderText="Treatment No" />
                             ...
                             <asp:BoundField DataField="Ipd" HeaderText="Ipd No" />
