<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OT_IPDPatientList.aspx.cs" Inherits="OT_IPDPatientList" %>
     ...
     <Triggers>
        ...
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>OT IPD Patient List</h1>
            <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">OT IPD Patient List</li>
                    </ol>
            </section>
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <div class="row">
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="IpdId,IpdNo"
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:BoundField DataField="PatRegId" HeaderText="Reg Id" ItemStyle-Width="60" Visible="True" >
                                                         ...
                                                         <asp:BoundField DataField="BillNo" HeaderText="BillNo" ItemStyle-Width="60" >
                                                        ...
                                                        <asp:BoundField DataField="FirstName" HeaderText="Patient Name" ItemStyle-Width="200" >
                                                         <ItemStyle Width="200px" />
                                                          ...
                                                          <asp:BoundField DataField="PatMainType" HeaderText="Patient Type" ItemStyle-Width="200" >
                                                         <ItemStyle Width="200px" />
                                                         </asp:BoundField>
                                                        <asp:BoundField DataField="PatientInsuType" HeaderText="Sub Patient Type" ItemStyle-Width="200" >
                                                         <ItemStyle Width="200px" />
                                                         </asp:BoundField>
                                                        ...
                                                        <asp:ButtonField CommandName="Report" Text="Report" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         ...
                                                         <asp:ButtonField CommandName="Summary" Text="Summary" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-secondary" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="Discharge" Text="Disc summary" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
