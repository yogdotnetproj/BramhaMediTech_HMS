...
public partial class DrCensusReport : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ObjDOReport.Get_DrCensus_AccountReport(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]));

            Session["Parameter"] = "Yes";
            Session["rptDate"] = txtFromDate.Text + "  To  " + txtToDate.Text;
