...
public partial class OPDvisitsforchildrenoto9 : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (PatientInformation.AgeType <> 'Years' OR PatientInformation.Age < 10) ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_OpdVisitChildren0To9.rpt");
        Session["reportname"] = "Rpt_OpdVisitChildren0To9";
