...
using System.Media;
public partial class MajorCase_Section : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (txtDate.Text != "")
        {
            ObjOCT.OperationDate = Convert.ToDateTime(txtDate.Text);
        }
        ...
        ObjOCT.SlidingScaleInsulin = ddlSliding.SelectedValue;
        ...
        ObjOCT.Insert_MajorCase_Section();
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Alter_MajorCase_Section_Report(Convert.ToInt32(Session["OTRegNo"]), Convert.ToInt32(Session["OTOpdNo"]), Convert.ToInt32(Session["OTIpdNo"]));
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Report/Rpt_MajorCase_Section_Report.rpt");
        Session["reportname"] = "MajorCase_Section_Report";
