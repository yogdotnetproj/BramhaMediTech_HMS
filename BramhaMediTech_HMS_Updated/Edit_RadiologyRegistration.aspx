<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="Edit_RadiologyRegistration.aspx.cs" Inherits="Edit_RadiologyRegistration" %>
                                    ...
                                    <div class="row"> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2 text-center">
                                                    ...
                                                    <div class="form-Inline form-check" font-bold="True">
                                                        <asp:RadioButtonList ID="RBLLabType" Enabled="false" runat="server"  RepeatDirection="Horizontal" AutoPostBack="True"  Font-Bold="True" Font-Size="Medium" Width="659px" OnSelectedIndexChanged="RBLLabType_SelectedIndexChanged" >
                                                             <asp:ListItem Value="P" >Pathology</asp:ListItem>
                                                             <asp:ListItem Value="R" Selected="True">Radiology</asp:ListItem>                                                            
                                        ...
                                        <div class="col-lg-12 mt-3" runat="server" visible="false"> 
                                         ...
                                         <div class="col-sm-3 text-left">
                                                        <div class="form-group"> 
                                                           <asp:DropDownList ID="ddlPatientCategoryName" runat="server" AutoPostBack="True" TabIndex="1" CssClass="form-control form-select"
                                     ...
                                     <asp:AutoCompleteExtender 
                                         ...
                                         <div class="col-lg-12 mt-3"> 
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                <div class="col-sm-5 text-left" runat="server" >
                                                            <div class="form-group">                                                                                           
                                  ...
                                  <div runat="server" id="KKK">
                                        ...
                                        <div id="InsuranceDetails" runat="server">  
                                                       ...
                                                       <div class="col-sm-2 text-left">
                                                        ...
                                                        <asp:TextBox ID="txtInsuranceAmt" runat="server"  CssClass="form-control"  height="30px"  AutoPostBack="True"
                                                     TabIndex="80" OnTextChanged="txtInsuranceAmt_TextChanged1"></asp:TextBox>
                                                               </div>
                                                        </div>
                                                           <div class="col-sm-2 text-left">
                                                    <div class="form-group">                                                      
                                        ...
                                        <div class="col-lg-12 mt-3">    
                                                    <div class="row">
                                                       ...
                                                       <div class="col-sm-2 text-left">
                                                        ...
                                                        <asp:TextBox ID="txtPaid" runat="server" Enabled="false" CssClass="form-control"  placeholder="Paid Amount" onkeyPress="return numeric_only(event);"
