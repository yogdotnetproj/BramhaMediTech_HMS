...
public partial class MonthlyDrSurgicalProductivityData : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            ddlMonth.Focus();
            ddlMonth.ForeColor = System.Drawing.Color.Red;
        ...
        else
        {
            Alterview();
            Session.Add("rptsql", "");
            Session["rptname"] = Server.MapPath("~/Reports/Rpt_Monthly_DrSurgicalProductivityData.rpt");
            Session["reportname"] = "Month_DRSurgicalProductivityData";
    ...
    public void Alterview()
    {
        ...
        string query = "ALTER VIEW [dbo].[VW_SurgicalProductivityData] AS (SELECT        OTRegisterDetails.OTId, OTRegisterDetails.Patregid, OTRegisterDetails.IPDNO, OTRegisterDetails.Surgan, OTRegisterDetails.ANAESTHETIST, OTRegisterDetails.FirstAssistant, OTRegisterDetails.SecondAssistant,   " +
                      ...
                      "  DepartmentMst ON IpdRegistration.DeptId = DepartmentMst.DeptId where Year(OTRegisterDetails.Createdon)=" + ddlYear.SelectedValue + "  and Month(OTRegisterDetails.Createdon)=" + ddlMonth.SelectedValue + "  ";
