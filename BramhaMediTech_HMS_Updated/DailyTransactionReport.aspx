<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="DailyTransactionReport.aspx.cs" Inherits="DailyTransactionReport" %>
            ...
            <section class="content">               
                         ...
                         <div class="box" runat="server" id="Panel3">
                             ...
                             <div class="box-header">
                                ...
                                <div class="col-sm-2" runat="server" visible="false">
                                    <div class="form-group">                                        
                                      <asp:TextBox ID="txtPatientName" runat="server" AutoPostBack="True" CssClass="form-control" width="210px" ontextchanged="txtPatientName_TextChanged" TabIndex="1"  Font-Bold="True" Font-Size="Larger" ></asp:TextBox>
