<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalTemp.master" AutoEventWireup="true" CodeFile="VisitForMalariaPatient.aspx.cs" Inherits="VisitForMalariaPatient" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>VisitFor Malaria Patient</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">VisitFor Malaria Patient </li>
                    </ol>
                </section>
                         ...
                         <div class="box" runat="server" id="Panel3">
                             ...
                             <div class="box-header">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DiagnosisName" HeaderText="Diagnosis">
