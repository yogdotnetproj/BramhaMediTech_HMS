...
using System.Media;
public partial class VAGINALHYSTERECTOMYFORPROLAPSE : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.UterineSize = txtUterineSize.Text;
        ObjOCT.CystoceleRemark = ddlCystocele.SelectedValue;
        ObjOCT.RectoceleRemark = ddlRectocele.SelectedValue;
        ObjOCT.OophrectomyRemark = ddlOophrectomy.SelectedValue;
        ObjOCT.Procedure = txtProcedure.Text;
        if (chkCystocele.Checked == true)
        {
            ObjOCT.Is_Cystocele = true; 
        }
        else
        {
            ObjOCT.Is_Cystocele = false; 
        }
        if (chkRectocele.Checked == true)
        {
            ObjOCT.Is_Rectocele = true;
        }
        else
        {
            ObjOCT.Is_Rectocele = false;
        }
        ...
        if (chkOophrectomy.Checked == true)
        {
            ObjOCT.Is_Oopherectomy = true;
        }
        else
        {
            ObjOCT.Is_Oopherectomy = false;
        }

        if (chkCystoceleRepaired.Checked == true)
        {
            ObjOCT.Is_CystoceleRepaired = true;
        }
        else
        {
            ObjOCT.Is_CystoceleRepaired = false;
        }
        if (chkRectoceleRepaired.Checked == true)
        {
            ObjOCT.Is_RectoceleRepaired = true;
        }
        else
        {
            ObjOCT.Is_RectoceleRepaired = false;
        }
        if (chkLevatorplastyDone.Checked == true)
        {
            ObjOCT.Is_LevatorplastyDone = true;
        }
        else
        {
            ObjOCT.Is_LevatorplastyDone = false;
        }
        if (chkSacrospinouspexy.Checked == true)
        {
            ObjOCT.Is_SacrospinouspexyDone = true;
        }
        else
        {
            ObjOCT.Is_SacrospinouspexyDone = false;
        }
        if (chkPackInserted.Checked == true)
        {
            ObjOCT.Is_PackInserted = true;
        }
        else
        {
            ObjOCT.Is_PackInserted = false;
        }

        ObjOCT.Insert_VAGINALHYSTERECTOMY_Section();
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Alter_VaginalHysterect_Section_Report(Convert.ToInt32(Session["OTRegNo"]), Convert.ToInt32(Session["OTOpdNo"]), Convert.ToInt32(Session["OTIpdNo"]));
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VaginalHystErect_Section_Report.rpt");
        Session["reportname"] = "VaginalHystErect_Section_Report";
