<%@ Page Title="Patients" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="MRC_IPDListPatients.aspx.cs" Inherits="MRC_IPDListPatients" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <section class="content-header d-flex">
                <h1>EMR MRC IPD Patient Lists</h1>
                <ol class="breadcrumb">
                       
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">EMR MRC IPD Patient Lists</li>
                    </ol>
            </section>
