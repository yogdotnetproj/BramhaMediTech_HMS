<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="FrontDesk_BillPayment.aspx.cs" Inherits="FrontDesk_BillPayment" %>
        ...
        <%-- <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>Front-Desk Bill Payment</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Front-Desk Bill Payment</li>
                    </ol>
                </section>
...
<FooterStyle ForeColor="Black"></FooterStyle>
                            ...
                            <asp:BoundField DataField="FinalBalance" HeaderText="Status"></asp:BoundField>
                                 ...
                                 <asp:BoundField DataField="Discount" HeaderText="Discount"/>
                                    ...
                                    <asp:BoundField DataField="AmountPaid" HeaderText="Amount Received"/>
                                     
                                    <asp:BoundField DataField="FinalBalance" HeaderText="Balance"/>
                                    <asp:BoundField DataField="BillGroup" HeaderText="Group"/>
                                  <asp:TemplateField HeaderText="Pay Receive">
                                 <ItemTemplate>
                                     <asp:CheckBox ID="ChkFinalSettelement"   runat="server" AutoPostBack="true" Checked='<%# Eval("PayonCashier") %>' OnCheckedChanged="ChkFinalSettelement_CheckedChanged"></asp:CheckBox>                                    
                                 </ItemTemplate>
                             </asp:TemplateField>
                                     ...
                                     <asp:TemplateField>
                                         <ItemTemplate>
                                             ...
                                             <asp:HiddenField ID="HdnBranchId" runat="server" Value='<%#Eval("BranchId") %>' />
                                              <asp:HiddenField ID="HdnProcBillPaymentId" runat="server" Value='<%#Eval("ProcBillPaymentId") %>' />
                                             <asp:HiddenField ID="HdnBillGroup" runat="server" Value='<%#Eval("BillGroup") %>' />
                                         </ItemTemplate>
                                     </asp:TemplateField>
                                 </Columns>
