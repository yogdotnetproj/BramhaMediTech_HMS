<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMaster.master" AutoEventWireup="true" CodeFile="Gynology_VitroFertilization.aspx.cs" Inherits="Gynology_VitroFertilization" %>
        ...
        <h1> In-Vitro Fertilization </h1>
         <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active"> Vitro Fertilization</li>
                    </ol>
    </section>
             ...
             <div class="box-header with-border">
               ...
               <div class="col-lg-12 mt-2">
                        ...
                        <div class="col-lg-2 text-left">
                         ...
                         <div class="col-lg-2 text-left">
                            ...
                            <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0 labelR">
                                          ...
                                          <asp:Label ID="Label4"  Font-Bold="true" runat="server" Text="E2" ></asp:Label>
                                    </div>
                                </div>
                         ...
                         <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0 labelR">
                                          ...
                                          <asp:Label ID="Label5" Font-Bold="true"  runat="server" Text="T3" ></asp:Label>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0 labelR">
                                        <asp:Label ID="Label6"  Font-Bold="true" runat="server" Text="LH" ></asp:Label>
                         ...
                         <div class="col-lg-2 text-left">
                            ...
                            <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0 labelR">
                                         ...
                                         <asp:Label ID="Label8"  Font-Bold="true" runat="server" Text="P4" ></asp:Label>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-2 text-left">
                         ...
                         <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0 labelR">
                                        ...
                                        <asp:Label ID="Label9"  Font-Bold="true" runat="server" Text="TSH" ></asp:Label>
                                    </div>
                                </div>
                         ...
                         <div class="col-lg-2 text-left">
                            ...
                            <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0 labelR">
                                        ...
                                        <asp:Label ID="Label10" Font-Bold="true"  runat="server" Text="Prolact" ></asp:Label>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-left">
                         ...
                         <div class="panel-heading mt-3">Antrial Follicle Count |-
                     </div>
                       <div class="col-lg-12 mt-2">
                    <div class="row">
                         ...
                         <div class="col-lg-12 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:TextBox ID="txtAntrialFollicleCount" placeholder="Enter Antrial Follicle Count" CssClass="form-control"  TextMode="MultiLine"  runat="server" />
                 ...
                 <div class="col-lg-12 mt-2">
                    <div class="row">
                         ...
                         <div class="col-lg-4 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:Label ID="Label2" Font-Bold="true"  runat="server" Text="Trial Transfer" ></asp:Label>
                                    </div>
                                </div>
                         <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:DropDownList ID="ddlTrialTransfer"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                        ...
                        <div class="col-lg-6 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:TextBox ID="txtTrialTransfer" placeholder="Enter Details+Length" CssClass="form-control"  TextMode="MultiLine"  runat="server" />
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-4 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:Label ID="Label3" Font-Bold="true"  runat="server" Text="Endometrial scrath" ></asp:Label>
                                    </div>
                                </div>
                         <div class="col-lg-3 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:DropDownList ID="ddlEndometrialscrath"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                        ...
                        <div class="col-lg-4 text-left">
                                    <div class="form-group form-check pl-0">
                                          <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">
                                                <asp:TextBox ID="txtEndometrialscrath" autocomplete="off" runat="server" class="form-control pull-right" TabIndex="1"></asp:TextBox>
                                                <span class="input-group-addon">
                                                     <i class="fa fa-calendar"></i>
                                                </span>
                                            </div>
                      ...
                      <div class="panel-heading mt-3">Treatment |-
                     </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:Label ID="Label7" Font-Bold="true"  runat="server" Text="DHEAS" ></asp:Label>
                                    </div>
                                </div>
                         <div class="col-lg-3 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:DropDownList ID="ddlDheas"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
                                        </asp:DropDownList>
                        ...
                        <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:Label ID="Label13" Font-Bold="true"  runat="server" Text="Long Agonist" ></asp:Label>
                                    </div>
                                </div>
                         <div class="col-lg-4 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:DropDownList ID="ddlLongAgonist"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
                                        </asp:DropDownList>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:Label ID="Label14" Font-Bold="true"  runat="server" Text="Antagonist" ></asp:Label>
                                    </div>
                                </div>
                         <div class="col-lg-3 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:DropDownList ID="ddlAntagonist"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
                                        </asp:DropDownList>
                        ...
                        <div class="col-lg-2 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:Label ID="Label15" Font-Bold="true"  runat="server" Text="OCs Date " ></asp:Label>
                                    </div>
                                </div>
                         <div class="col-lg-4 text-left">
                                    <div class="form-group form-check pl-0">
                                         <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">
                                                <asp:TextBox ID="txtocDate" autocomplete="off" runat="server" class="form-control pull-right" TabIndex="1"></asp:TextBox>
                                                <span class="input-group-addon">
                                                     <i class="fa fa-calendar"></i>
                                                </span>
                                            </div>
                 ...
                 <div class="col-lg-12 mt-2">
                   ...
                   <div class="col-lg-3 text-left">
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-12 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:TextBox ID="txtHysteroscopyFindings" placeholder="Enter Hysteroscopy Findings |" CssClass="form-control" Height="100px" TextMode="MultiLine" runat="server" />
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-12 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:TextBox ID="txtDlap" placeholder="Enter Lap"  Height="100px" CssClass="form-control"  TextMode="MultiLine" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:Label ID="Label16"  Text="Previous Infertility Treatment History:"  runat="server" />
                                        </div>
                            </div>
                         <div class="col-lg-6 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:TextBox ID="txtPrevInfertilityTreatment" placeholder="Previous Infertility Treatment History"   CssClass="form-control"  TextMode="MultiLine" runat="server" />
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-12 text-left">
                                    <div class="form-group form-check pl-0">
                                        <asp:TextBox ID="txtremark" placeholder="Remark"  Height="75px"  CssClass="form-control"  TextMode="MultiLine" runat="server" />
                        ...
                        <ContentTemplate>
                            ...
                            <div class="body">
                                <asp:GridView ID="gvdChief" runat="server" AutoGenerateColumns="false"
                                    class="table table-responsive table-sm table-bordered" Width="100%" DataKeyNames="VitroId"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="YearOfInfert" HeaderText="Year Of Infert"  />
                                         <asp:BoundField DataField="YearOfInfert1" HeaderText="Year Of Infert Remark"  />
                                         <asp:BoundField DataField="SemenAnalysisNote" HeaderText="Semen Analysis Note "  />
                                          <asp:BoundField DataField="Fibroids" HeaderText="Fibroids"  />
                                          <asp:BoundField DataField="VitroNote" HeaderText=" Notes"  />
