<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OpdBillOutstanding.aspx.cs" Inherits="OpdBillOutstanding" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>OPD Bill Details</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">OPD Bill Details</li>
                    </ol>
                </section>
                                   ...
                                   <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2">
                                       ...
                                       <div class="form-Inline form-check"> 
                                        ...
                                        <asp:Button ID="btnReset" runat="server" onclientclick="target = '_blank';" onclick="btnReset_Click" CssClass="btn btn-primary" 
                                            Text="Report" />
                                                    </div>
                                          </div>
                                        </div>
...
<FooterStyle ForeColor="Black"></FooterStyle>
                            ...
                            <asp:BoundField DataField="BalanceAmt" HeaderText="Status"></asp:BoundField>
                                    ...
                                    <%--<asp:BoundField DataField="BillNo" HeaderText="Bill No">
                                        ...
                                        <asp:BoundField DataField="PatMainType" HeaderText="Pat Type">                                  
                                     </asp:BoundField>
                                       <asp:BoundField DataField="PatientInsuType" HeaderText="Insu Type">                                  
                                     </asp:BoundField>
                                   ...
                                   <%-- <asp:BoundField DataField="CreatedBy" HeaderText="User Name"/>
                                     ...
                                     --%>
                             <asp:TemplateField HeaderText="Edit Dr">
                                 <ItemTemplate>
                                     <asp:Button ID="btnAddBill" runat="server" Text="Edit Dr" OnClick="btnAddBill_Click"  />
                                 </ItemTemplate>
                             </asp:TemplateField>
                                     <asp:TemplateField>
                                         <ItemTemplate>
