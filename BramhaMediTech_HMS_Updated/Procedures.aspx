<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="Procedures.aspx.cs" Inherits="Procedures" %>
                ...
                <input id="rdbdiscPer" type="radio"   runat="server" name="rdbDisc" value="Per" />
                  <label for="rdbdiscPer">Per(%)</label>
                                        ...
                                        <div class="col-lg-12 mt-3">  
                                                    <div class="row">
                                                       ...
                                                       <div class="col-sm-4 text-left">
                                                        ...
                                                        <asp:TextBox ID="txtbalance" runat="server" Enabled="false" CssClass="form-control"     placeholder="Balance" onkeyPress="return numeric_only(event);"
                                        ...
                                        TabIndex="15" CssClass="btn btn-primary" OnClick="btnCasePaper_Click"  />
                                              ...
                                              <asp:Button ID="btnDataForm" runat="server" Text="Data Form"    UseSubmitBehavior="false" OnClientClick="this.disabled='true';this.Value='Please Wait...';"
