<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OTRegisterAdd.aspx.cs" Inherits="IpdBillForPatientServices" %>
    ...
    <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>
            <section class="content-header d-flex">
                <h1>General OT Register</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">General OT Register</li>
                    </ol>
            </section>
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-left">
                                ...
                                <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                        <asp:Label ID="lblPrnNo" runat="server" Font-Bold="true" ForeColor="Blue" Text="Reg ID:" ></asp:Label>
                                        <asp:Label ID="lblPatRegId" runat="server" Text="1"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                        <asp:Label ID="lblPat" runat="server" Font-Bold="true" ForeColor="Blue" Text="Patient Name:"></asp:Label>
                                        <asp:Label ID="lblPatientName" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
                                <div id="Div2" class="col-lg-2 text-left" runat="server" >
                                    <div class="form-group">
                                        <asp:Label ID="lblI"  runat="server" Font-Bold="true" ForeColor="Blue" Text="IPD NO:"></asp:Label>
                                        <asp:Label ID="lblIpd" runat="server" Text="0"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                        <asp:Label ID="lblBio" runat="server" Font-Bold="true" ForeColor="Blue" Text="Bill NO:"></asp:Label>
                                        <asp:Label ID="lblBillNo" runat="server" Text="1"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                        <asp:Label ID="hhhd" runat="server" Font-Bold="true" ForeColor="Blue" Text="Room Name :"></asp:Label>
                         ...
                         <div class="row">
                            <div class="col-lg-12 text-left">
                                <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                        <asp:Label id="lblPa" runat="server" Font-Bold="true" ForeColor="Blue" Text="Patient Category:"></asp:Label>
                                        <asp:Label ID="lblPatCat" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                        <asp:Label id="lblAde" runat="server" Font-Bold="true" ForeColor="Blue" Text="Admission Date:"> </asp:Label>
                                 ...
                                 <div id="Div3" class="col-lg-2 text-left" runat="server" >
                                    <div class="form-group">
                                        <asp:Label id="lblm"   runat="server" Font-Bold="true" ForeColor="Blue" Text="DR Name :"></asp:Label>
                                        <asp:Label ID="lbldrname" runat="server" Text="0"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                        <asp:label id="lblBi" runat="server" Font-Bold="true" ForeColor="Blue" Text="Room Type:" ></asp:label>
                                        <asp:Label ID="LblRoomType" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                        <asp:label id="kk" runat="server" Font-Bold="true" ForeColor="Blue" Text="Bed Name:"></asp:label>
                         ...
                         <div class="row">
                            <div class="col-lg-12 text-left">
                                <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                        <asp:Label id="Label1" runat="server" Font-Bold="true" ForeColor="Maroon" Text="Diagnosis:"></asp:Label>
                                        <asp:Label ID="Label2" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                        <asp:Label id="Label3" runat="server" Font-Bold="true" ForeColor="Maroon" Text="Procedure:"> </asp:Label>
                                 ...
                                 <div id="Div4" class="col-lg-2 text-left" runat="server" >
                                    <div class="form-group">
                                        <asp:Label id="Label5"   runat="server" Font-Bold="true" ForeColor="Maroon" Text="Sponsor :"></asp:Label>
                                        <asp:Label ID="Label6" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                        <asp:label id="Label7" runat="server" Font-Bold="true" ForeColor="Maroon" Text="Sponsor1:" ></asp:label>
                                        <asp:Label ID="Label8" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                        <asp:label id="Label9" runat="server" Font-Bold="true" ForeColor="Maroon" Text="Visit No:"></asp:label>
                    ...
                    <div class="box-body">
                             ...
                             <div class="row"> 
                                  ...
                                  <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txt2stAsst" runat="server" AutoPostBack="true"  CssClass="form-control" placeholder="Enter 2ST Asst"></asp:TextBox>        
                                                        <asp:AutoCompleteExtender 
                                                MinimumPrefixLength="1"  
                                                ServiceMethod="Search1stAsst"                                                
                                                CompletionInterval="100"
                             ...
                             <div class="row"> 
                                  ...
                                  <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txtSTERINURSE" runat="server"  CssClass="form-control" placeholder="Enter STERI NURSE"></asp:TextBox>        
                                  ...
                                  <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txtDISEASE" runat="server"  CssClass="form-control" placeholder="Enter DISEASE"></asp:TextBox>        
                                 ...
                                 <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txtoperation" runat="server"  CssClass="form-control" placeholder="Enter OPERATION"></asp:TextBox>        
                                 ...
                                 <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txttimestart" runat="server"  CssClass="form-control" placeholder="Enter Time Start"></asp:TextBox>        
                             ...
                             <div class="row"> 
                                  ...
                                  <div class="col-lg-3 text-left" >
                                                    <div class="form-group">  
                                                         ...
                                                         <asp:TextBox ID="txttimeEnd" runat="server"  CssClass="form-control" placeholder="Enter Time End"></asp:TextBox>        
                     ...
                     <div class="col-lg-12" runat="server" visible="false">
                                ...
                                <div class="col-lg-1 text-left" style="width:600px">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-left" style="width:250px"">
                                                    <div class="form-group">  
                                                ...
                                                Width="700px" AutoPostBack="True"  onkeyPress="return alpha_only(event);" OnTextChanged="txtBillServices_TextChanged" ></asp:TextBox>
                                              <%--<div style=" overflow: scroll; width: 550px; height: 100px; text-align: right"
                                                                                id="Div6">
                                                                            </div>--%>
                                                         <asp:AutoCompleteExtender  
                                    ...
                                    <div class="row">
                                              ...
                                              <%--  <div class="col-lg-2 text-left" style="width:250px"">
                                                ...
                                                <div class="col-lg-3 text-left" style="width:310px"">
                                                    <div class="form-group">  
                                                         ...
                                                         <textarea  runat="server" style="height:30px;width:300px" id="txtdescription" cols="1"  rows="1"></textarea>        
                                        ...
                                        <div class="col-lg-2 text-left" runat="server" visible="false">                                            
                                            <div class="form-group"> 
                                              ...
                                              <div class="col-lg-2 text-left" style="width:250px" runat="server" id="Doctor">
                                                    <div class="form-group">  
                                                ...
                                                Width="200px" AutoPostBack="True"  onkeyPress="return alpha_only(event);" OnTextChanged="txtConsDoctorName_TextChanged"></asp:TextBox>
                                               <asp:AutoCompleteExtender 
                                                MinimumPrefixLength="1"  
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                <div class="col-lg-1 text-left" style="width:150px">
                                                    <div class="form-group">  
                                                        ...
                                                        class="form-control" placeholder=" Charges" TabIndex="13" Width="90px"></asp:TextBox>                    
                                          ...
                                          <div class="col-lg-1 text-left" style="width:150px">
                                                    <div class="form-group"> 
                                                        ...
                                                        class="form-control" placeholder=" Qty" TQabIndex="13" Width="50px" OnTextChanged="txtQty_TextChanged"></asp:TextBox>                    
                                        ...
                                        <div class="col-lg-1 text-left" style="width:100px">
                                                    <div class="form-group"> 
                                                        ...
                                                        class="form-control"  TabIndex="13" Width="100px"></asp:TextBox>                    
