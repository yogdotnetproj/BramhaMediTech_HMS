...
public partial class CancelIPDDesk : System.Web.UI.Page
{
    ...
    public void refreshdata()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("usp_GetIpdPatientList_CancelBill", con))
            {
    ...
    protected void gvPatientInfo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            string response = @"~/IpdRefundPayment.aspx?RegId=" + PatRegId + "&IpdId=" + IpdId + "&ISCancel=Yes";
