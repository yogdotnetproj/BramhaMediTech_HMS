<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="TotalVisitHospitalPatients.aspx.cs" Inherits="TotalVisitHospitalPatients" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Total Visit Hospital Patients</h1>
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Total Visit Hospital Patientst</li>
                    </ol>
                </section>
...
<asp:DropDownList ID="ddlTimeTo" runat="server" CssClass="form-control form-select"></asp:DropDownList>
                             ...
                             <div class="box-body">
                                   <div class="table-responsive" style="width:100%">          
                                    ...
                                    <asp:GridView ID="gvPatientInfo" runat="server" Visible="false" AutoGenerateColumns="False" DataKeyNames="PatientInfoId"
