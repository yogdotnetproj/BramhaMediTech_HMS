...
public partial class VisitForNumberofNormaldeliveryPatient : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where DeliveryNote.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and   DeliveryNote.ModeofDelivery='Normal' ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VisitForNormalDeliveryPatient.rpt");
        Session["reportname"] = "Rpt_VisitForNormalDeliveryPatient";
