<%@ Page Title="General EMR" Language="C#" EnableEventValidation="false" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="DailyDrNote.aspx.cs" Inherits="DailyDrNote" %>
            ...
            <section class="content-header d-flex">
                ...
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Daily Dr Note</li>
                                 ...
                                 <div class="row">
                                      ...
                                      <div class="col-sm-3 text-left">
                                                           <div class="form-group"> 
                                                                 <asp:CheckBox ID="ChkDiscReco" CssClass="BigCheckBox" AutoPostBack="false" ForeColor="Red" Font-Bold="true" runat="server"  Text="&nbsp;Discharge recommendation"  />
                                     ...
                                     <div class="col-lg-2">
                                            <div class="form-group">
                                                 <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">                                                            
                                                          <asp:TextBox ID="txtRegistrationDate" runat="server"   class="form-control"   AutoPostBack="false"></asp:TextBox>
                                     ...
                                     <div class="col-sm-3 text-left">
                                                    <div class="form-group">     
                                                          <asp:TextBox runat="server"  id="txtDischargeremarks" placeholder="Enter Remark" CssClass="form-control" ></asp:TextBox>
                                                        </div>
                                         </div>
                                      <div class="col-sm-2 text-left" >
<asp:Button runat="server" ID="btndischarged" Text="Discharge Recommendation" CssClass="btn btn-danger" OnClick="btndischarged_Click"  />
                                           </div>
                                     </div>
                                 </div>
                          ...
                          <div class="col-lg-5">
                              <div class="col-lg-12 mt-3">
                                     ...
                                     <div class="col-lg-2" >
                                      ...
                                      <div class="col-lg-4" >
                                        <asp:DropDownList ID="ddlPlan" CssClass="form-control form-select" runat="server" >
                                              ...
                                              <asp:ListItem Value="1">Transfer Out</asp:ListItem>
                               ...
                               <div class="col-lg-12 mt-3">
                                 <div class="row">
                                     ...
                                     <div class="col-lg-2" >
                                         <strong>ICD 11 Diagnosis</strong>
                                         </div>
                                      
                                     <div class="col-lg-10" >
                                         <asp:TextBox ID="txtICd11" runat="server"  AutoCompleteType="None"  CssClass="form-control mt-2" placeholder="Enter ICD 11 Diagnosis"
                           ...
                           <div class="col-lg-12 mt-3">
                                 <div class="row">
                                     ...
                                     <div class="col-lg-10" >
                                        <asp:TextBox ID="txtRemarks" CssClass="form-control" placeholder="Remarks" runat="server" TextMode="MultiLine"></asp:TextBox>
                                           </div>
                                     </div>
                               </div>
                               <div class="col-lg-12 mt-2 " >
...
<asp:Button runat="server" ID="btnTreatment" Text="Save Treatment" CssClass="btn btn-warning" OnClick="btnTreatment_Click"  />
                             ...
                             <div class="row" >
                                    <div class="col-lg-12 mt-3 text-center" >
                                        <asp:Button ID="btnSave"  CssClass="btn btn-success" runat="server" Enabled="false" Text="Save" OnClick="btnSave_Click"  OnClientClick="this.disabled=true;" UseSubmitBehavior="false" />
