...
public partial class IPD_PRNOrder : BaseClass
{
    ...
    public void Get_TReatment_Details(int Patregid, int IPDNo)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("Usp_IPD_PRNOrder", con))
            {
    ...
    private void InsertInBill()
    {
       ...
       // objDALBillInfo.InsertIPD_Admissionsheet(objBELBillInfo);
        ...
        objDALBillInfo.Delete_IPDPRNOrder(RegId, IpdId);
        for (int i = 0; i < GvHairLaser.Rows.Count; i++)
        {

            //extract the TextBox values

            TextBox box1 = (TextBox)GvHairLaser.Rows[i].Cells[1].FindControl("txtMedication");
            TextBox box2 = (TextBox)GvHairLaser.Rows[i].Cells[2].FindControl("txtDoseSign1");
            TextBox box3 = (TextBox)GvHairLaser.Rows[i].Cells[3].FindControl("txtDoseSign2");
            TextBox box4 = (TextBox)GvHairLaser.Rows[i].Cells[4].FindControl("txtDoseSign3");
            TextBox box5 = (TextBox)GvHairLaser.Rows[i].Cells[5].FindControl("txtDoseSign4");
            TextBox box6 = (TextBox)GvHairLaser.Rows[i].Cells[6].FindControl("txtDoseSign5");
            TextBox box7 = (TextBox)GvHairLaser.Rows[i].Cells[7].FindControl("txtDoseSign6");
            TextBox box8 = (TextBox)GvHairLaser.Rows[i].Cells[8].FindControl("txtDoseSign7");
            objBELBillInfo.P_Medication = box1.Text;
            objBELBillInfo.P_DoseSign1 = box2.Text;
            objBELBillInfo.P_DoseSign2 = box3.Text;
            objBELBillInfo.P_DoseSign3 = box4.Text;
            objBELBillInfo.P_DoseSign4 = box5.Text;
            objBELBillInfo.P_DoseSign5 = box6.Text;
            objBELBillInfo.P_DoseSign6 = box7.Text;
            objBELBillInfo.P_DoseSign7 = box8.Text;
            objDALBillInfo.InsertIPD_PRNOrder_Details(objBELBillInfo);
        }
    }
    ...
    private void SetInitialRow()
    {
        ...
        dt.Columns.Add(new DataColumn("DoseSign1", typeof(string)));
        dt.Columns.Add(new DataColumn("DoseSign2", typeof(string)));
        dt.Columns.Add(new DataColumn("DoseSign3", typeof(string)));
        dt.Columns.Add(new DataColumn("DoseSign4", typeof(string)));
        dt.Columns.Add(new DataColumn("DoseSign5", typeof(string)));
        dt.Columns.Add(new DataColumn("DoseSign6", typeof(string)));
        dt.Columns.Add(new DataColumn("DoseSign7", typeof(string)));
        dr = dt.NewRow();

        dr["RowNumber"] = 1;

        dr["Medication"] = string.Empty;
        dr["DoseSign1"] = string.Empty;
        dr["DoseSign2"] = string.Empty;
        dr["DoseSign3"] = string.Empty;
        dr["DoseSign4"] = string.Empty;
        dr["DoseSign5"] = string.Empty;
        dr["DoseSign6"] = string.Empty;
        dr["DoseSign7"] = string.Empty;
    ...
    private void SetPreviousData()
    {
        ...
        if (ViewState["CurrentTable"] != null)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    TextBox box1 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[1].FindControl("txtMedication");
                    TextBox box2 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[2].FindControl("txtDoseSign1");
                    TextBox box3 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[3].FindControl("txtDoseSign2");
                    TextBox box4 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[4].FindControl("txtDoseSign3");
                    TextBox box5 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[5].FindControl("txtDoseSign4");
                    TextBox box6 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[6].FindControl("txtDoseSign5");
                    TextBox box7 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[7].FindControl("txtDoseSign6");
                    TextBox box8 = (TextBox)GvHairLaser.Rows[rowIndex].Cells[8].FindControl("txtDoseSign7");

                    box1.Text = dt.Rows[i]["Medication"].ToString();
                    box2.Text = dt.Rows[i]["DoseSign1"].ToString();
                    box3.Text = dt.Rows[i]["DoseSign2"].ToString();
                    box4.Text = dt.Rows[i]["DoseSign3"].ToString();
                    box5.Text = dt.Rows[i]["DoseSign4"].ToString();
                    box6.Text = dt.Rows[i]["DoseSign5"].ToString();
                    box7.Text = dt.Rows[i]["DoseSign6"].ToString();
                    box8.Text = dt.Rows[i]["DoseSign7"].ToString();
        ...
        if (ViewState["CurrentTable"] != null)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                {
                    ...
                    dtCurrentTable.Rows[i - 1]["Medication"] = box1.Text;
                    dtCurrentTable.Rows[i - 1]["DoseSign1"] = box2.Text;
                    dtCurrentTable.Rows[i - 1]["DoseSign2"] = box3.Text;
                    dtCurrentTable.Rows[i - 1]["DoseSign3"] = box4.Text;
                    dtCurrentTable.Rows[i - 1]["DoseSign4"] = box5.Text;
                    dtCurrentTable.Rows[i - 1]["DoseSign5"] = box6.Text;
                    dtCurrentTable.Rows[i - 1]["DoseSign6"] = box7.Text;
                    dtCurrentTable.Rows[i - 1]["DoseSign7"] = box8.Text;
                    rowIndex++;
                }
