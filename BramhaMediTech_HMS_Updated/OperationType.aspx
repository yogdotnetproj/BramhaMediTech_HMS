<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OperationType.aspx.cs" Inherits="OperationType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section class="content-header d-flex">
                    <h1>Operation Category</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Operation Category</li>
                    </ol>
                </section>
      ...
      <section class="content">
                            ...
                            <asp:GridView ID="gvOpCat" runat="server" AutoGenerateColumns="False" DataKeyNames="OprnCatId"
                            class="table table-responsive table-sm table-bordered" Width="100%" 
                            AlternatingRowStyle-BackColor="White" HeaderStyle-ForeColor="Black" 
                            CellPadding="3" AllowPaging="True" PageSize="10"
                            OnRowDeleting="gvOpCat_RowDeleting" OnRowEditing="gvOpCat_RowEditing"
                             OnPageIndexChanging="gvOpCat_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="OprnCatId" HeaderText="OprnCatId" Visible="False" />
                                <asp:BoundField DataField="OprnCat" HeaderText="Rate Type"/>                         
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtOpCat">Operation Category:</label>                                                                                
                                                    </div>
                                         </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">                                                    
                                              
                                              <asp:TextBox ID="txtOpCat" runat="server" placeholder="Enter Operation Category(*)" CssClass="form-control" 
