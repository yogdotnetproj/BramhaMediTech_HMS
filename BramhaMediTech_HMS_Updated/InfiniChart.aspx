<%@ Page Title="" Language="C#" MasterPageFile="~/DermatologyMaster.master" AutoEventWireup="true" CodeFile="InfiniChart.aspx.cs" Inherits="InfiniChart" %>
     ...
     <Triggers>
            ...
            <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Infini Chart</li>
                    </ol>                
                </section>
                    ...
                    <div class="row">
                            <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                         <asp:gridview ID="GvInfiChart" runat="server" ShowFooter="true" Width="100%" AutoGenerateColumns="false">
        ...
        <asp:TemplateField HeaderText="Date" >
            ...
            <ItemTemplate>
                 <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">
                                                <asp:TextBox ID="txtAntaDate" autocomplete="off" runat="server" class="form-control pull-right" ></asp:TextBox>
       ...
       <asp:TemplateField HeaderText="Area" >
            ...
            <ItemTemplate>
                ...
                <asp:TextBox ID="txtDepth" CssClass="form-control" runat="server"></asp:TextBox>
