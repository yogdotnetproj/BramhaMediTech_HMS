<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="SpecialityProductivityData.aspx.cs" Inherits="SpecialityProductivityData" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Speciality Productivity Data</h1>
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Speciality Productivity Data</li>
                    </ol>
                </section>
                                    ...
                                    <div class="row">                                
                                       ...
                                       <div class="col-sm-4">                                    
                                           ...
                                           <asp:Button ID="btnExcel" runat="server" CssClass="btn btn-warning"   Text="Excel" OnClick="btnExcel_Click" />
                                             <asp:Button ID="btnChart" runat="server" CssClass="btn btn-success"   Text="Chart" OnClick="btnChart_Click" />
