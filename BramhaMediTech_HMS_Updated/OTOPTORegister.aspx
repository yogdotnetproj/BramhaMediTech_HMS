<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OTOPTORegister.aspx.cs" Inherits="OTOPTORegister" %>
            ...
            <section class="content-header d-flex">
                ...
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">OT Register</li>
                    </ol>
            </section>
                        ...
                        <div class="row">  
                            ...
                            <div class="col-sm-3" >
                                        <div class="form-group form-check">
                                            <asp:DropDownList ID="ddlRoomCategoryNew" Visible="false" runat="server" AutoPostBack="True" CssClass="form-control form-select"
                                                              TabIndex="18">
                                                            </asp:DropDownList>                   
                                                        <asp:RadioButtonList ID="RblOTType" runat="server" RepeatDirection="Horizontal" AutoPostBack="false" OnSelectedIndexChanged="RblOTType_SelectedIndexChanged">
                                                            <asp:ListItem Selected="True" Value="1" Text="General"></asp:ListItem>
                                                            <asp:ListItem Value="0" Text="EYE"></asp:ListItem>
                                                            <asp:ListItem Value="2" Text="CathLab"></asp:ListItem>
                                                                </asp:RadioButtonList>
                                            </div>
                                </div>
                            <div class="col-sm-1">
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:BoundField DataField="InvoiceNo" HeaderText="Invoice No" ItemStyle-Width="100"  >
                                                         ...
                                                         <ItemStyle Width="100px" />
                                                          ...
                                                          <asp:BoundField DataField="RType" HeaderText="Room Type" ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
