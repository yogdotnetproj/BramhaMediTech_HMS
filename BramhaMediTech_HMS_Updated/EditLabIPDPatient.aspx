<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="EditLabIPDPatient.aspx.cs" Inherits="EditLabIPDPatient" %>
        ...
        <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>IPD Lab Patients</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">IPD Lab Patients</li>
                    </ol>
                </section>
                         ...
                         <div class="box" runat="server" id="Panel3">
                             ...
                             <div class="box-header">
                              ...
                              <div id="Div2" class="col-sm-7" runat="server"  >
                                    ...
                                    <div class="row">
                                       ...
                                       --%> 
                                        <asp:Button ID="btnReset" runat="server" onclick="btnReset_Click" CssClass="btn btn-warning" 
                                            Text="Reset" />
                                              <asp:Button ID="btnreport" runat="server"  CssClass="btn btn-success" 
                                 ...
                                 <asp:GridView ID="gvDailyCash"  runat="server" AllowPaging="True" datakeynames="PatRegId,LabNo"
                            ...
                            <asp:TemplateField HeaderText="Final Bill" Visible="false">
                                 <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="IpdNo" HeaderText="IPD No"/>
                                     <asp:BoundField DataField="MainDoctor" HeaderText="Main Dr."/>
