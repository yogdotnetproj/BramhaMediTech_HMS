...
public partial class LaparoscopicHysterectomy_Section : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        //........................
        ObjOCT.SizeofUterus = txtsizeofuterus.Text;
        ...
        ObjOCT.AdhesionsRemark = ddlAdhesions1.SelectedValue;
        ...
        ObjOCT.EndometriosisRemark = ddlEndometriosis.SelectedValue;
        if (chkOopherectomy.Checked == true)
        {
        ...
        if (chkBladderChecked.Checked == true)
        {
            ObjOCT.BladderChecked = true;
        }
        else
        {
            ObjOCT.BladderChecked = false;
        }
        if (chkBowelChecked.Checked == true)
        {
            ObjOCT.BowelChecked = true;
        }
        else
        {
            ObjOCT.BowelChecked = false;
        }

        ObjOCT.MorcellatorUsed = ddlMorcellator.SelectedValue;
        ...
        ObjOCT.Insert_Hysterectomy_Section();
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Alter_Hysterectomy_Section_Report(Convert.ToInt32(Session["OTRegNo"]), Convert.ToInt32(Session["OTOpdNo"]), Convert.ToInt32(Session["OTIpdNo"]));
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Report/Rpt_LaparoscopicHysterectomy_Section_Report.rpt");
        Session["reportname"] = "LaparoscopicHysterectomy";
