...
public partial class EmergencyObservation : System.Web.UI.Page
{
    ...
    public void FillPurchaseOrderList()
    {
        ...
        gvPurchaseList.DataSource = transaction.SearchEmergencyPatientList(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]), SuppId, PoNo, 0, DrId, MobNo, status,"Nurse");
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        int Opd = Convert.ToInt32(gvPurchaseList.DataKeys[row.RowIndex]["Opd"].ToString());
        ...
        string sql = "";
        Alter_view(PatientRegId, Opd,TreatmentId);
    ...
    protected void btnDetails_Click(object sender, EventArgs e)
    {
        ...
        string response = @"~/EditDrugListForNurse.aspx?TreatmentId=" + TreatmentId + "&RegId=" + PatientRegId + "&OpdNo=" + Opd + "&IPDNO=" + IPDNO + "&PType=OPD&SType=Emergency";

        Response.Redirect(string.Format(response));
    }

    public void Alter_view(int PatientRegId, int Opd,int TreatmentId)
    {
        string sql = "";
        ...
        " where tbl_TreatmentTransaction.TreatmentId=" + Convert.ToInt32(TreatmentId) + " and tbl_Treatment.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (tbl_Treatment.PatientRegId = " + Convert.ToString(PatientRegId) + ") AND (tbl_Treatment.Opd = " + Convert.ToString(Opd) + ")    ";//AND (tbl_Treatment.Ipd = "+Convert.ToString(Session["EmrIpdNo"])+")
