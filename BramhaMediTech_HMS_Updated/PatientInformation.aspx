                        ...
                        <div class="col-lg-12 mt-3">
                                        ...
                                        <div class="col-lg-12 mt-3"> 
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                 ...
                                                 <div  class="col-sm-2">
                                                    <div class="form-group">
                                                         <label for="txtEmail">ID card no :</label>   
                                                        </div>
                                                    </div>                                                                 
                                                <div class="col-sm-2" >
                                                    <div class="form-group">
                                                        
                                                             <asp:TextBox ID="txtpassportNo" runat="server" CssClass="form-control" placeholder="Enter ID card no"  
                                                           ></asp:TextBox>
                                                        </div>
                                                </div>  
                          ...
                          <div class="col-lg-12 mt-3">
                                        ...
                                        <asp:Button ID="btnUpload" runat="server" CausesValidation="False" 
                                            CssClass="btn btn-info" onclick="btnUpload_Click"   TabIndex="10" 
                                            Text="Upload" />
                     ...
                     <div class="box-footer">
                                    <div class="row">
                                        ...
                                        TabIndex="12" Width="80px" CssClass="btn btn-success"   CausesValidation="False"   UseSubmitBehavior="false" OnClientClick="this.disabled='true';this.Value='Please Wait...';" />
                                            <asp:Button ID="btnCard" runat="server" TabIndex="13"  Text="Card" autopostback="true"
                                                 Width="80px" class="btn btn-primary"  CausesValidation="False" OnClick="btnCard_Click" />
                                             <asp:Button ID="btnOPD" runat="server" Visible="false" TabIndex="14" onclick="btnOPD_Click" Text="OPD" 
                                                 Width="80px" class="btn btn-warning"  CausesValidation="False" />
                                             <asp:Button ID="btnLab" runat="server" TabIndex="14" Text="LAB" 
                                                 Width="80px" class="btn btn-primary" onclick="btnLab_Click"  CausesValidation="False" />
                                              <asp:Button ID="btnProcedure" runat="server" TabIndex="14" Text="Procedure" 
                                                 Width="100px" CssClass="btn btn-secondary"  CausesValidation="False" OnClick="btnProcedure_Click" />

                                                <asp:Button ID="btnIPD" runat="server" TabIndex="15"  Text="IPD" 
                                                Width="80px" class="btn btn-danger"  CausesValidation="False" onclick="btnIPD_Click" />
                                        ...
                                        Text="Back" Width="80px" class="btn btn-success" CausesValidation="False" TabIndex="17" />
                                                         <asp:Button ID="btncapturephoto" runat="server"   TabIndex="33"  Text="Capture Photo" CssClass="btn btn-success" OnClick="btncapturephoto_Click"  ></asp:Button>
                                           <asp:Button ID="btnbabycard" runat="server"   Text="Baby Card" autopostback="true"
                                                 Width="110px" class="btn btn-danger"  CausesValidation="False" OnClick="btnbabycard_Click"  />
                                             </div>
                                    </div>
                         <div class="row">
