<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="PatientFollowUp.aspx.cs" Inherits="PatientFollowUp" %>
             ...
             <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Patient FollowUp</li>
                    </ol>
                </section>
                         ...
                         <div class="box" runat="server" id="Panel3">
                            ...
                            <asp:BoundField DataField="PatRegId" HeaderText="Reg No" 
                                    ...
                                    <asp:BoundField DataField="PatientName" HeaderText="Patient Name">                                     
                                     ...
                                     <asp:BoundField DataField="AgeType1" HeaderText="Age/Gender">                                   
                                     </asp:BoundField>
                                     ...
                                     <asp:BoundField DataField="DoctorName" HeaderText="Doctor Name">                                   
                                      ...
                                      <asp:BoundField DataField="FollowUpDate" HeaderText="FollowUp Date" DataFormatString="{0:dd/MM/yyyy}" >                                   
                                     </asp:BoundField>
                                    <asp:BoundField DataField="MobileNo" HeaderText="Mobile No">
                                     ...
                                     <asp:ButtonField CommandName="EmailSend"  ImageUrl="~/Images0/EmailImage.jpg" HeaderText="Email"  ItemStyle-Width="80" ButtonType="Image" >
                                                        
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>

                                     <asp:ButtonField CommandName="Whatapp"  ImageUrl="~/Images0/Whatapp.jpg" HeaderText="WhatApp"  ItemStyle-Width="90" ButtonType="Image" >
