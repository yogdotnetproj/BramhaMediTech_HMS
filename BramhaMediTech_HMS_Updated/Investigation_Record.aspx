<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="Investigation_Record.aspx.cs" Inherits="Investigation_Record" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
     ...
     <section class="content-header d-flex">
        <h1>Investigation Record</h1>
         <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Investigation Record</li>
                    </ol>
    </section>
    <section class="content">
       ...
       <asp:TemplateField HeaderText="Investigation" >
            ...
            <ItemTemplate>
                ...
                <asp:TextBox ID="txtInvestigation" Text='<%# Eval("Investigation") %>' CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <ItemTemplate>
                ...
                <asp:TextBox ID="txtCost" Text='<%# Eval("Cost") %>' CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <ItemTemplate>
                ...
                <asp:TextBox ID="txtCreatedBy" Text='<%# Eval("CreatedBy") %>' Enabled="false" CssClass="form-control" runat="server"></asp:TextBox>
             ...
             <asp:Button ID="ButtonAdd" runat="server" Text="Add New Row" OnClick="ButtonAdd_Click" />
                ...
                <div class="col-lg-12 mt-3 text-center">
                    <div class="form-group">
                        ...
                        <asp:Button ID="btnReport" runat="server" Text="Report" Visible="false" class="btn btn-warning btnSearch" OnClick="btnReport_Click"  />                                       
