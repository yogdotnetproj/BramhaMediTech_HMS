...
public partial class CS : BasePage
{
    ...
    public static bool SaveCapturedImage(string data)
    {
     ...
     //  string  imgByte11 = Convert.ToString( imageBytes);
        ...
        sc = new SqlCommand("" +
             "update PatientInformation set  Image1=@Image1,ImagePathPhoto='" + fileName + ".jpg' where  PatRegId=@PatRegId ", conn);
       ...
       // sc.Parameters.Add(new SqlParameter("@PatRegId", SqlDbType.Int)).Value = PID;
