<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="SearchQuotationPatientList.aspx.cs" Inherits="SearchQuotationPatientList" %>
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtBillNo" runat="server"  placeholder="Mobile No" CssClass="form-control"
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        <div class="row">
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="ProcedureId"
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:BoundField DataField="Age" HeaderText="Age" ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                          ...
                                                          <asp:BoundField DataField="AgeType" HeaderText="AgeType" ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
                                                         ...
                                                         <asp:BoundField DataField="DrName" HeaderText="DrName" ItemStyle-Width="200"  >
                                                         <ItemStyle Width="200px" />
                                                         </asp:BoundField>

                                                         <asp:BoundField DataField="BillAmount" HeaderText="Charges" ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="CreatedOn" HeaderText="Date" ItemStyle-Width="100" DataFormatString="{0:dd/MM/yyyy}" >
                                                         <ItemStyle Width="100px" />
                                                          ...
                                                          <asp:ButtonField CommandName="CasePaper" Text="Quotation" HeaderText="Quotation" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
