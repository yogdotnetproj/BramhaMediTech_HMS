...
using System.Media;
public partial class LaparoscopicEctopic_Section : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
       ...
       //........................
        ObjOCT.Haemoperitonium = ddlHaemoperitonium.SelectedValue;
        ObjOCT.Side = ddlSide.SelectedValue;
        ObjOCT.Ruptured = ddlRuptured.SelectedValue;
        ObjOCT.Adhesions = ddlAdhesions.SelectedValue;
       
        ObjOCT.SpecimenRetrieval = ddlSpecimenRetrieval.SelectedValue;
        ObjOCT.Bloodclotssuctioned = ddlBloodandClots.SelectedValue;
        ...
        ObjOCT.Insert_LaparoscopicEctopic_Section();
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Alter_LaparoscopicEctopic_Section_Report(Convert.ToInt32(Session["OTRegNo"]), Convert.ToInt32(Session["OTOpdNo"]), Convert.ToInt32(Session["OTIpdNo"]));
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Report/Rpt_Laparoscopic_Cyste_Section_Report.rpt");
        Session["reportname"] = "LaparoscopicEctopic";
