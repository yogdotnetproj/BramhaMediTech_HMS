<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="CancelProcedurePatient.aspx.cs" Inherits="CancelProcedurePatient" %>
     ...
     <Triggers>
        ...
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>Cancel Procedure</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Cancel Procedure</li>
                    </ol>
            </section>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="BillNo,PatRegId,ProcedureId"
                                                    ...
                                                    BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" PageSize="15" ShowHeaderWhenEmpty="True" OnRowEditing="gvPatientInfo_RowEditing">
                                                    ...
                                                    <Columns>  
                                                       ...
                                                       <%-- <asp:ButtonField CommandName="Report" Text="Cancel Procedure" OnClientClick="return ValidateDelete();" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
