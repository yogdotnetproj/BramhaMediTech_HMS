<%@ Page Title="" Language="C#" MasterPageFile="~/OT_mainMaster.master" AutoEventWireup="true" CodeFile="LaparoscopicHysterectomy_Section.aspx.cs" Inherits="LaparoscopicHysterectomy_Section" %>
            ...
            <section class="content-header d-flex">
                    ...
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Laparoscopic Hysterectomy</li>
                    </ol>                
                </section>
                        ...
                        <div class="panel-heading">
                            <div class="col-lg-12 text-center">
                                ...
                                <div class="col-sm-4" >
                                        ...
                                        <div class="col-sm-4" >
                                            <div class="form-group">
                                               <asp:TextBox ID="txtsizeofuterus" CssClass="form-control"  runat="server" placeholder="" ></asp:TextBox>
                                                </div>
                                    </div>
                                ...
                                <div class="col-sm-4" >
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlAdhesions1"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                                     <asp:ListItem Value="Bowel">Bowel</asp:ListItem>
                                                     <asp:ListItem Value="Bladder">Bladder</asp:ListItem>
                                                    <asp:ListItem Value="Omentum">Omentum</asp:ListItem>
                                          ...
                                          <asp:ListItem Value=""></asp:ListItem>
                                                  ...
                                                  <div class="col-lg-12 mt-2">
                                                      <div class="row">
                                                           <div class="col-sm-4" >
                                            <div class="form-group">
                                                 <asp:CheckBox runat="server" ID="chkOopherectomy" Text="Oopherectomy" />
                                                </div>
                                    </div>
                                <div class="col-sm-4" >
                                            <div class="form-group">
                                                 ...
                                                 <div class="col-lg-12 mt-2">
                                                      <div class="row">
                                                           <div class="col-sm-4" >
                                            <div class="form-group">
                                                <asp:CheckBox runat="server" ID="chkBladderChecked" Text="Bladder Checked" />
                                                </div>
                                    </div>
                                <div class="col-sm-4" >
                                            <div class="form-group">
                                                  ...
                                                  <div class="col-lg-12 mt-2">
                                                      <div class="row">
                                                           <div class="col-sm-4" >
                                            <div class="form-group">
                                                <asp:CheckBox runat="server" ID="chkBowelChecked" Text="Bowel Checked" />
                                                </div>
                                    </div>
                                <div class="col-sm-4" >
                                            <div class="form-group">
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                               <strong> Hysterectomy done with sealer,bipolar,unipolar,diathermy and scissors</strong>
                                                </div>
                                    </div>
                                                 ...
                                                 <div class="col-lg-12 mt-2">
                                                      <div class="row">
                                                          <div class="col-sm-6" >
                                            <div class="form-group">
                                              <strong> Morcellator Used:</strong> 
                                                </div>
                                                              </div>
                                <div class="col-sm-6" >
                                            <div class="form-group">
                                                 <asp:DropDownList ID="ddlMorcellator"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                               <strong> Speciman Retrieved</strong>            
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                               <strong> Opsite re checked through telescope</strong>            
