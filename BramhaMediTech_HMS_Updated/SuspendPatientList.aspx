<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="SuspendPatientList.aspx.cs" Inherits="ReportCancelRegistration" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Suspend and Resume  Report</h1>
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Suspend and Resume  Report</li>
                    </ol>
                </section>
                      ...
                      <div class="box" runat="server" id="show">
                             ...
                             <div class="box-body">
                                   <div class="table-responsive" style="width:100%">          
                                    ...
                                    <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="SuspendId"
                                ...
                                <asp:BoundField DataField="PatientAddress" HeaderText="Address" 
                                    ...
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                           ...
                                           <asp:BoundField DataField="SuspendedBy" HeaderText="SuspendedBy" 
                                     ItemStyle-HorizontalAlign="Left">
                                    <ItemStyle HorizontalAlign="Left" Width="100px" />
                                </asp:BoundField>   
                                 <asp:BoundField DataField="SuspendOn" HeaderText="SuspendOn" 
                                     ItemStyle-HorizontalAlign="Left">
                                    <ItemStyle HorizontalAlign="Left" Width="100px" />
                                </asp:BoundField>
                                             <asp:BoundField DataField="SuspendRemark" HeaderText="Suspend Remark" /> 
                                             <asp:BoundField DataField="ResumeBy" HeaderText="Resume By" ItemStyle-HorizontalAlign="Left">
                                    <ItemStyle HorizontalAlign="Left" Width="150px" />
                                </asp:BoundField>
                                             <asp:BoundField DataField="ResumeOn" HeaderText="ResumeOn" ItemStyle-HorizontalAlign="Left">
                                    <ItemStyle HorizontalAlign="Left" Width="150px" />
                                </asp:BoundField>
                                             <asp:BoundField DataField="ResumeRemark" HeaderText="Resume Remark" /> 
