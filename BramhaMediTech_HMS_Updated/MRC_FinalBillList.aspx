<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="MRC_FinalBillList.aspx.cs" Inherits="MRC_FinalBillList" %>
            ...
            <section class="content-header d-flex">
                ...
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active"> MRC Bill list</li>
                    </ol>
            </section>
                               ...
                               <div class="col-sm-2 text-left">
                                    ...
                                    <div class="col-sm-1 text-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnReportPdf"  runat="server" Text="Report" TabIndex="3" ValidationGroup="Date" CssClass="btn btn-primary btnSearch" OnClick="btnReportPdf_Click" />
                                        </div>
                                            </div>
                                    </div>
                                             <div class="col-sm-1 text-left">
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnReportExcel"  runat="server" Text="Excel" TabIndex="3" ValidationGroup="Date" CssClass="btn btn-warning btnSearch" OnClick="btnReportExcel_Click" />
                                        </div>
                                            </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="IpdId"
                                                    ...
                                                    <Columns>  
                                                         ...
                                                         <asp:ButtonField CommandName="SelectEMR" Text="EMR" HeaderText="EMR"  Visible="false" ControlStyle-CssClass="btn btn-primary" ButtonType="Button" ItemStyle-Width="80" >                                                    
                                                        ...
                                                        <asp:ButtonField CommandName="Report" Text="Report" Visible="false" HeaderText="Report" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-primary" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         ...
                                                         <asp:ButtonField CommandName="Discharge"  ImageUrl="~/Images0/EmailImage.jpg" HeaderText="Email"  ItemStyle-Width="80" ButtonType="Image" >
                                                        
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="ReAdmit" Text="Edit"  HeaderText="Edit" ControlStyle-CssClass="btn btn-danger" ItemStyle-Width="80" ButtonType="Button" >
