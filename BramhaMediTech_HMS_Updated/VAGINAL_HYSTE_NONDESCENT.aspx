<%@ Page Title="" Language="C#" MasterPageFile="~/OT_mainMaster.master" AutoEventWireup="true" CodeFile="VAGINAL_HYSTE_NONDESCENT.aspx.cs" Inherits="VAGINAL_HYSTE_NONDESCENT" %>
     ...
     <Triggers>
        ...
        <ContentTemplate>
            <section class="content-header d-flex">
                    <h1>VAGINAL HYSTERECTOMY – NON DESCENT</h1>
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">VAGINAL HYSTERECTOMY – NON DESCENT</li>
                    </ol>                
                </section>
                    ...
                    <div class="row">
                        <div class="panel-heading">
                            <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <strong>VAGINAL HYSTERECTOMY – NON DESCENT</strong>
                                        </div>
                                </div>
                        </div>
                                ...
                                <div class="col-sm-3" >
                                            ...
                                            <div class="form-group">
                                                Site
                                                           ...
                                                           <div class="col-sm-4" >
                                            <div class="form-group">
                                                     <asp:TextBox ID="txtsite" CssClass="form-control"   runat="server" placeholder="" ></asp:TextBox>  
                                             </div>            
                                       </div>
                                          ...
                                          <asp:ListItem Value=""></asp:ListItem>
                                            ...
                                            <div class="form-group">
                                              Comments
                                                            ...
                                                            <div class="col-sm-8" >
                                            <div class="form-group">
                                                     <asp:TextBox ID="txtcomments" CssClass="form-control" TextMode="MultiLine" Height="120px"  runat="server" placeholder="" ></asp:TextBox>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                             1.Parts cleaned and draped ,bladder emptied with metal catheter
                                                </div>
                                    </div>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                             2.Cervix held with vulseiium forceps and sub mucosal infiltration done with normal saline anteriorly and on ths sides
                                                </div>
                                    </div>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                             3.Vaginal mucosa incised circumferentially and reflected
                                                </div>
                                    </div>
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                              6.Vault closed after ensuring haemostasis
                                                </div>
                                    </div>                                                       
                                ...
                                <div class="col-sm-12" >
                                            <div class="form-group">
                                              7.Foleys inserted and inflated 
                                                </div>
                                    </div>                                                       
                                ...
                                <div class="col-sm-3" >
                                            <div class="form-group">
                                              8.Pack Inserted 
                                                          ...
                                                          <div class="col-sm-3" >
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlpackInsert"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                                <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                <asp:ListItem Value="No">No</asp:ListItem>
