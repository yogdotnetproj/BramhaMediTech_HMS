...
public partial class IpdPatientListForAdvanceReceipt : System.Web.UI.Page
{
    ...
    public void refreshdata()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("usp_GetIpdPatientListForAdvanceReceipt", con))
            {
    ...
    protected void gvPatientInfo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Select")
        {
            ...
            string response = @"~/IpdAdvanceReceiptPrint.aspx?RegId=" + PatRegId + "&IpdId=" + IpdId;
    ...
    protected void btnreport_Click(object sender, EventArgs e)
    {
        ...
        objreports.IpdPatientRefundList_Report(RoomTypeId, Convert.ToInt32(ViewState["PatientInfoId"]), Convert.ToInt32(Session["FId"]), Convert.ToInt32(Session["Branchid"]), txtStart.Text, txtEnd.Text);
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Reports/Rpt_IPDRefundPatientReport.rpt");
        Session["reportname"] = "Rpt_IPDRefundPatientReport";
        Session["RPTFORMAT"] = "pdf";
