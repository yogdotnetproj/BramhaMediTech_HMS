<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="OTGeneralRegister.aspx.cs" Inherits="OTGeneralRegister" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>OT General Register</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">OT General Register</li>
                    </ol>
            </section>
                        ...
                        <div class="row">
                                     ...
                                     <div class="col-lg-2  text-left" style="width:220px">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">
                                                <asp:TextBox ID="txtStart" autocomplete="off"  Width="150px" runat="server" class="form-control pull-right" TabIndex="1"></asp:TextBox>
                                     ...
                                     <div class="col-lg-2  text-left" style="width:200px">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" data-autoclose="true">
                                                <asp:TextBox ID="txtEnd" autocomplete="off" Width="150px"  runat="server" class="form-control pull-right" TabIndex="2"></asp:TextBox>
                                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                            </div>
                                    ...
                                    <div class="col-lg-12" >
                                         <div class="row">
                                                ...
                                                Width="200px" AutoPostBack="True" ontextchanged="txtPatientName_TextChanged"  onkeyPress="return alpha_only(event);"></asp:TextBox>
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                               ...
                                               <div class="col-lg-1 text-left" style="width:200px">
                                                        <div class="form-group"> 
                                                            <label for="ddlRoomCategory" style="text-align:left">Room Category:</label>                                                                                                                                                                                              
                                                         </div>
                                               </div>
                                                <div class="col-lg-2 text-left" style="width:220px">
                                                            <div class="form-group">                                                                                           
                                   
                                                            <asp:DropDownList ID="ddlRoomCategory" runat="server" Width="190px" AutoPostBack="True" class="form-control"
