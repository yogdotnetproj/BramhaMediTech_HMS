...
public partial class OPDvisitsforchildren6Day : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (PatientInformation.AgeType = 'Days') and (PatientInformation.Age < 7) ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_OpdVisitChildren0To6Days.rpt");
        Session["reportname"] = "Rpt_OpdVisitChildren0To6Days";
