<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalTemp.master" AutoEventWireup="true" CodeFile="NeonataltetanusprophylaxisPatient.aspx.cs" Inherits="NeonataltetanusprophylaxisPatient" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>Neonatal tetanus prophylaxis Patient</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Neonatal tetanus prophylaxis Patient</li>
                    </ol>
                </section>
