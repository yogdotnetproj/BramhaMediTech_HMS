...
using System.Media;
public partial class VAGINAL_HYSTE_NONDESCENT : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Oophrectomy = ddlOophrectomy.SelectedValue;
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Alter_VAGINAL_HYSTE_NONDESCENT_Report(Convert.ToInt32(Session["OTRegNo"]), Convert.ToInt32(Session["OTOpdNo"]), Convert.ToInt32(Session["OTIpdNo"]));
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VAGINAL_HYSTE_NONDESCENT_Report.rpt");
        Session["reportname"] = "VAGINAL_HYSTE_NONDESCENT_Report";
