<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="InsuranceSummaryForProcedure.aspx.cs" Inherits="InsuranceSummaryForProcedure" %>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <asp:Button ID="btnSearch" OnClick="btnSearch_Click" runat="server" Text="Search" TabIndex="3" ValidationGroup="Date" class="btn btn-success" />
                                                <asp:Button ID="btnPrint" runat="server" CausesValidation="False" class="btn btn-warning" 
                                        ...
                                        <div class="row">
                                                ...
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="PatRegId"
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:BoundField DataField="Details"  HeaderText="Details " ItemStyle-Width="200" >
                                                         ...
                                                         <asp:BoundField DataField="chargeNumber" HeaderText="charge Number" ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
                                         ...
                                         <ItemTemplate>
                                             ...
                                             <asp:HiddenField ID="HdnOpdNo" runat="server" Value='<%#Eval("OPDNo") %>' />
                                              <asp:HiddenField ID="HdnProcedureNo" runat="server" Value='<%#Eval("ProcedureID") %>' />
