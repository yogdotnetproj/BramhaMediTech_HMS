...
public partial class EmergencyObservations : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (tempDatatable != null && tempDatatable.Rows.Count > 0)
            {
                ...
                {
                    res = objTreat.InsertUpdateDeleteMain_Observ(ttype);
                     ViewState["res"] = res;
                }
                else
                {
                    ...
                    if (res > 0)
                    {
                        ...
                        for (int i = 0; i < tempDatatable.Rows.Count; i++)
                        {
                            ...
                            {
                                int r = transaction.InsertUpdateDeleteMain_Observation("Insert");
                                if (r > 0)
                                {
