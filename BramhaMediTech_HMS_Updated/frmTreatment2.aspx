<%@ Page Title="Treatment" EnableEventValidation="false" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="frmTreatment2.aspx.cs" Inherits="frmTreatment2" %>
                        ...
                        <div class="row">
                                 ...
                                 <div class="row">
                                      ...
                                      <div class="col-lg-2 text-left">
                                              <div class="form-group"> 
                                                   ...
                                                   <asp:TextBox ID="txtnewDose"  CssClass ="form-control" onkeyPress="return numeric_only(event);"   runat="server" ></asp:TextBox> 
                                     ...
                                     <div class="col-lg-2 text-left" >
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlDoseTime" runat="server"  CssClass="form-control" AutoPostBack="false"   ></asp:DropDownList>
                                    ...
                                    <div class="col-lg-12 mt-2 text-left">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtNote" runat="server"  
                                                AutoPostBack="false" TextMode="MultiLine" TabIndex="4" CssClass="form-control">
                                            </asp:TextBox>
                                        </div>
                                    </div>
                                              ...
                                              <div class="form-group">
                                                  <asp:TextBox ID="txtverbalby" runat="server"  
                                                        AutoPostBack="false"   CssClass="form-control" placeholder=" Verbal order by" Font-Bold="True" Font-Size="Medium" ></asp:TextBox>                    
                                                           ...
                                                           <div id="Div4" class="col-lg-12 mt-3 " runat="server" >
                                                          <div class="row">
                            ...
                            <div class="col-lg-6" >
                                              ...
                                              <div class="form-group">  
                                                 ...
                                                 <div runat="server" id="Div1" style="height:450px;  overflow:scroll"   >                                          
              ...
              <%-- <div class="col-lg-12 text-right">
                        <div class="row">
                                        ...
                                        <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click"
                                            Width="80px" class="btn btn-primary btnSearch" CausesValidation="False"  OnClientClick="this.disabled=true;" UseSubmitBehavior="false" />
                   ...
                   <div class="col-lg-12 mt-3 text-center">
                             ...
                             <asp:Button ID="btnreport" runat="server" Text="Prescription" 
                                        ...
                                        <asp:Button ID="btnBack" runat="server" OnClientClick="window.history.back()"
                                            Text="Back" class="btn btn-secondary" CausesValidation="False" />
