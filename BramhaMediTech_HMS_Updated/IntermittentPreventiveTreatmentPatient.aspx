<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalTemp.master" AutoEventWireup="true" CodeFile="IntermittentPreventiveTreatmentPatient.aspx.cs" Inherits="IntermittentPreventiveTreatmentPatient" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>Intermittent Preventive Treatment Patient </h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Intermittent Preventive Treatment Patient</li>
                    </ol>
                </section>
