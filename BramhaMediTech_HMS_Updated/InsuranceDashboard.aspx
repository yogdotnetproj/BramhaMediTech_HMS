<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="InsuranceDashboard.aspx.cs" Inherits="InsuranceDashboard" %>
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                           <asp:TextBox runat="server" ID="txtInsuranceid" AutoPostBack="true" placeholder=" Insurance Company" CssClass="form-control" OnTextChanged="txtInsuranceid_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="col-lg-12 mt-3" >
                                         <div class="row">
                                                  <div class="col-sm-2">
                                                        <div class="form-group"> 
                                                            <label for="txtPatientName" style="text-align:left">Patient Name/RegNo</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div>                             
                                                  <div class="col-sm-3">
                                                    <div class="form-group">                 
                                            ...
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="IpdId"
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:TemplateField HeaderText="Sponsor Amt">
                                                            <ItemTemplate>

                                                                <asp:TextBox runat="server" Width="100px" Text='<%#Eval("Sponsor1Amt") %>' ID="sponsor1"></asp:TextBox>
                                                            </ItemTemplate>
                                                         ...
                                                         <asp:TemplateField HeaderText="Sponsor Amt2">
                                                            <ItemTemplate>

                                                                <asp:TextBox runat="server" Width="100px" Text='<%#Eval("Sponsor2Amt") %>' ID="Sponsor2"></asp:TextBox>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:ButtonField CommandName="Select" Text="Action" ControlStyle-CssClass="btn btn-primary" ButtonType="Button" ItemStyle-Width="80" >                                                    
                                                         <ControlStyle CssClass="btn btn-primary" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                        <asp:ButtonField CommandName="Report" Text="Report" ControlStyle-CssClass="btn btn-primary" Visible="false" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-primary" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="Summary" Text="Summary" ControlStyle-CssClass="btn btn-primary" Visible="false" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-primary" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
