...
public partial class MalariaprophylaxisPatient : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (ANCExamination.IPT1='True')  ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VisitForMalariaprophylaxisPatient.rpt");
        Session["reportname"] = "Rpt_VisitForMalariaprophylaxisPatient";
