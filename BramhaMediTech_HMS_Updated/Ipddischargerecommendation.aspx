<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="Ipddischargerecommendation.aspx.cs" Inherits="Ipddischargerecommendation" %>
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1> IPD Discharge Recommendation List</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">IPD Discharge Recommendation List</li>
                    </ol>
            </section>
                               ...
                               <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnReport"  runat="server" Text="Report"  ValidationGroup="Date" CssClass="btn btn-warning btnSearch" OnClick="btnReport_Click" />
                                        </div>
                                            </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="IpdId"
                                                    ...
                                                    <Columns>  
                                                         <asp:ButtonField CommandName="Select" Text="Select" Visible="false" HeaderText="select" ControlStyle-CssClass="btn btn-success" ButtonType="Button" ItemStyle-Width="80" >                                                    
                                                        ...
                                                        <asp:BoundField DataField="DateOfAdmission" HeaderText="Admission Date" ItemStyle-Width="100" DataFormatString="{0:dd/MM/yyyy}" >
                                                         ...
                                                         <asp:BoundField DataField="RecoDate" HeaderText="Recommendation Date" ItemStyle-Width="100" DataFormatString="{0:dd/MM/yyyy}" >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
                                                        <asp:BoundField DataField="RecoTime" HeaderText="Reco Time" ItemStyle-Width="90" >                                                        
                                                         <ItemStyle Width="90px" />
                                                         </asp:BoundField>
                                                          <asp:BoundField DataField="RecoBy" HeaderText="Recommendation By" ItemStyle-Width="150" >                                                        
                                                         <ItemStyle Width="150px" />
                                                         </asp:BoundField>
                                                        
                                                          <asp:BoundField DataField="Reco_NurseApproveBy" HeaderText="NurseApprove By" ItemStyle-Width="150" >                                                        
                                                         <ItemStyle Width="150px" />
                                                         </asp:BoundField>
                                                          <asp:BoundField DataField="Reco_NurseApproveOn" HeaderText="NurseApprove On" ItemStyle-Width="150" >                                                        
                                                         <ItemStyle Width="150px" />
                                                         </asp:BoundField>
                                                          <asp:BoundField DataField="Reco_FinanceApproveBy" HeaderText="Finance Approve By" ItemStyle-Width="150" >                                                        
                                                         <ItemStyle Width="150px" />
                                                         </asp:BoundField>
                                                          <asp:BoundField DataField="Reco_FinanceApproveOn" HeaderText="Finance Approve On" ItemStyle-Width="150" >                                                        
                                                         <ItemStyle Width="150px" />
                                                         </asp:BoundField>
                                                        <asp:BoundField DataField="RecoRemark" HeaderText="Remark " ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="BillAmount" HeaderText="Bill Amount" ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
                                                        <asp:ButtonField CommandName="Report" Text="Discharge slip" HeaderText="Discharge slip" ControlStyle-CssClass="btn btn-warning" ItemStyle-Width="80" ButtonType="Button" >
