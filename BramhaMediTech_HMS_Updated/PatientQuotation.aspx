<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="PatientQuotation.aspx.cs" Inherits="PatientQuotation" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
       ...
       <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Patient Quotation</h1>
                    <ol class="breadcrumb">
                        
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Patient Quotation</li>
                    </ol>
                </section>
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-lg-12 mt-3"> 
                                            ...
                                            <div class="row">  
                                                ...
                                                <div id="Div2" class="col-sm-10  text-left" runat="server">
                                                    <div class="form-group">
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                            ...
                            <SortedDescendingHeaderStyle BackColor="#00547E" />
                                        ...
                                        TabIndex="15" CssClass="btn btn-success"  />
                                              ...
                                              <asp:Button ID="btnCasePaper" runat="server" Text="Report"  Visible="false"  UseSubmitBehavior="false" onclientclick="target = '_blank';" 
