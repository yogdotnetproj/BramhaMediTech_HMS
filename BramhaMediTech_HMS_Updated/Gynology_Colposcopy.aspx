<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMaster.master" AutoEventWireup="true" CodeFile="Gynology_Colposcopy.aspx.cs" Inherits="Gynology_Colposcopy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    </style><script src="Scripts/moment.js"></script><script src="Scripts/jquery-3.0.0.js"></script><script src="Scripts/jquery-ui-1.12.1.js"></script><script src="Scripts/jquery.auto-complete-1.0.7.js"></script><script src="Scripts/bootstrap.js"></script>
        ...
        <h1>Colposcopy  </h1>
         <ol class="breadcrumb ">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Colposcopy </li>
                    </ol>
    </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                     ...
                                     <strong>  Pap smear Report</strong>
                                        
                                    </div>
                                </div>
                        <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                       <asp:DropDownList ID="ddlPApSmear"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="CSIL">CSIL</asp:ListItem>
                                            <asp:ListItem Value="HSIL">HSIL</asp:ListItem>
                                            <asp:ListItem Value="AGCUS">AGCUS</asp:ListItem>
                         ...
                         <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                      ...
                                      <strong>  Ecto-Cervix:Normal</strong>
                                        
                                    </div>
                                </div>
                        <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                       <asp:DropDownList ID="ddlEcto"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                     ...
                                     <strong>  SCJ:seen</strong>
                                        
                                    </div>
                                </div>
                        <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                       <asp:DropDownList ID="ddlSCJ"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
                         ...
                         <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                      ...
                                      <strong>  Transition zone:seen</strong>
                                        
                                    </div>
                                </div>
                        <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                       <asp:DropDownList ID="ddlTransition"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                     ...
                                     <strong>  Biopsy sites</strong>
                                        
                                    </div>
                                </div>
                        <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                       <asp:TextBox ID="txtBiopsysites" CssClass="form-control"  runat="server" placeholder="Biopsy sites " ></asp:TextBox>
                                        </div>
                              </div>
                         <div class="col-lg-2 text-left">
                                    <div class="form-group">
                                       
                                      <strong>  Acto White Area</strong>
                                        
                                    </div>
                                </div>
                        <div class="col-lg-3 text-left">
                                    <div class="form-group">
                                       <asp:DropDownList ID="ddlActoWhiteArea"  CssClass="form-control form-select"  runat="server" >
                                           <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-left">
                         ...
                         <div class="col-lg-8 text-left">
                                    <div class="form-group">
                                         <asp:TextBox ID="txtNotes" CssClass="form-control" TextMode="MultiLine"  runat="server" placeholder="Notes " ></asp:TextBox>
                                        </div>
                             </div>
                        </div>
                            </div>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="body">
                                <asp:GridView ID="gvdChief" runat="server" AutoGenerateColumns="false"
                                    class="table table-responsive table-sm table-bordered" Width="100%" DataKeyNames="Colid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ColposcopyDate" HeaderText="Date"  />
                                        
                                        <asp:BoundField DataField="PapsmearReport" HeaderText="Papsmear Report"  />
                                          <asp:BoundField DataField="Ect_Cervix" HeaderText="Ect Cervix"  />
                                       
                                         <asp:BoundField DataField="SCJ" HeaderText="SCJ"  />
                                        <asp:BoundField DataField="TransitionZone" HeaderText="Transition Zone"  />
                                        <asp:BoundField DataField="Biopsysites" HeaderText="Biopsy sites"  />
                                        <asp:BoundField DataField="ActoWhiteArea" HeaderText="ActoWhite Area"  />
