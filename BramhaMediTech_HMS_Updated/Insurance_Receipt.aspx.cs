...
public partial class Insurance_Receipt : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        ...
        gvDailyCash.DataSource = ObjDOReport.Fill_AllInsurancr_Receipt(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]), Convert.ToInt32(Sponser), BranchId, "0"); //Convert.ToInt32(ddlUser.SelectedValue));
    ...
    protected void Print_Click(object sender, EventArgs e)
    {
      ...
      //  int ReceiptNo = Convert.ToInt32(ddlreceipts.SelectedValue);
        ...
        objreports.InsurancePaymentReceipts_Report(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]),Sponser, "0", BranchId);
