<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="EMR_LabPatientRegistration.aspx.cs" Inherits="EMR_LabPatientRegistration" %>
                                            ...
                                            <asp:TextBox ID="txtTotalCharges"  runat="server" readonly="true" onkeyPress="return numeric_only(event);"
                                              ...
                                              <div class="form-group"> 
                                                      <asp:TextBox ID="txtclinicalHistory" runat="server"  
                                                        AutoPostBack="false" TextMode="MultiLine"  CssClass="form-control" placeholder=" Clinical History" TabIndex="15"  Font-Bold="True" Font-Size="Medium" ></asp:TextBox>                    
                                              ...
                                              <div class="form-group"> 
                                                  <asp:DropDownList runat="server"  CssClass="form-control form-select"  ID="ddlWardName"></asp:DropDownList>
                                                               ...
                                                               <div id="Div7" class="col-lg-8 " runat="server" >
                                              <div class="form-group">
                                                  <asp:TextBox ID="txtverbalby" runat="server"  
                                                        AutoPostBack="false"   CssClass="form-control" placeholder=" Verbal order by" Font-Bold="True" Font-Size="Medium" ></asp:TextBox>                    
                                                          ...
                                                          <div class="row">
                                                           <div id="Div21" class="col-lg-12 " runat="server" >
                                              <div class="form-group">
                            ...
                            <Columns>                                
                              ...
                              <FooterStyle BackColor="White" ForeColor="#000066" />
                                    ...
                                    <asp:Button ID="btnReset" runat="server" Text="Reset" OnClick="btnReset_Click" 
                                        ...
                                        TabIndex="15" class="btn btn-primary" OnClick="btnreport_Click"  />
                                     ...
                                     <label>Group Name</label>
                                            <div id="Div15" class="row" runat ="server" visible="false">
                                          ...
                                          <div class="row">
                                              ...
                                              <div id="Div17" class="col-lg-1 text-left" style="width:110px" runat="server" visible="false">
                                                    <div class="form-group">     
