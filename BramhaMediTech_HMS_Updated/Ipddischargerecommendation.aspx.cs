...
public partial class Ipddischargerecommendation : System.Web.UI.Page
{
    ...
    public void refreshdata()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("usp_GetIpddischargerecommendation", con))
            {
    ...
    protected void gvPatientInfo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Report")
        {
            ...
            string response = @"~/DischargeSlip.aspx?RegId=" + PatRegId + "&IpdId=" + IpdId;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        objreports.Ipddischargerecommendation_Report(RoomTypeId, Convert.ToInt32(ViewState["PatientInfoId"]), Convert.ToInt32(Session["FId"]), Convert.ToInt32(Session["Branchid"]), txtStart.Text, txtEnd.Text);
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Reports/Rpt_dischargerecommendation_Report.rpt");
        Session["reportname"] = "Rpt_dischargerecommendation";
