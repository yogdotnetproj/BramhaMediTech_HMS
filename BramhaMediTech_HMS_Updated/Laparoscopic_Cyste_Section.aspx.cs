...
using System.Media;
public partial class Laparoscopic_Cyste_Section : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
       ...
       // ObjOCT.PostOperativeAnaesthetist = txtpostoperativeAnaesthetist.Text;
        ...
        ObjOCT.Insert_Laparoscopic_Cyste_Section();
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        ObjOCT.Alter_Laparoscopic_Cyste_Section_Report(Convert.ToInt32(Session["OTRegNo"]), Convert.ToInt32(Session["OTOpdNo"]), Convert.ToInt32(Session["OTIpdNo"]));
        Session.Add("rptsql", sql);
        Session["rptname"] = Server.MapPath("~/Report/Rpt_Laparoscopic_Cyste_Sectio_Report.rpt");
        Session["reportname"] = "Laparoscopic_Cyste_Sectio";
