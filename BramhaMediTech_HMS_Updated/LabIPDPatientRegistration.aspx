<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="LabIPDPatientRegistration.aspx.cs" Inherits="LabIPDPatientRegistration" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Lab IPD Registration</h1>
                    <ol class="breadcrumb">
                       
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Lab IPD Registration</li>
                    </ol>
                </section>
            <section class="content">
                 ...
                 <div class="box" runat="server" id="Show">
                   ...
                   <!--  <div class="box-header with-border">
                          ...
                          <asp:Label ID="lblVisitingNo" class="red pull-center"  runat="server" Font-Bold="True" ForeColor="#0066FF" Font-Size="Medium" Width="559px" ></asp:Label>
                                    ...
                                    <div class="row"> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 text-center">
                                                    ...
                                                    <div class="form-Inline form-check" font-bold="True">
                                                        <asp:RadioButtonList ID="RBLLabType" runat="server"  RepeatDirection="Horizontal" AutoPostBack="True"  Font-Bold="True" Font-Size="Medium" Width="659px" OnSelectedIndexChanged="RBLLabType_SelectedIndexChanged" >
                                        ...
                                        <div class="col-lg-12 mt-3" runat="server" visible="false"> 
                                         ...
                                         <div class="col-sm-3">
                                               ...
                                               <div class="col-sm-2">
                                                        <div class="form-group"> 
                                                            <label for="ddlPatientSubCategoryName"> SubCategory</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div>
                                         <div class="col-sm-4">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12 mt-3"> 
                                          ...
                                          <div class="col-lg-12 mt-3"> 
                                            <div class="row">
                                                ...
                                                <div id="Div2" class="col-sm-10" runat="server">
                                                    <div class="form-group">
                                     ...
                                     <asp:AutoCompleteExtender 
                                           ...
                                           CompletionListCssClass="AutoExtender"
                                            ...
                                            TabIndex="19" ></asp:TextBox>
                                                 ...
                                                 <div id="Div3" class="col-sm-2" runat="server" visible="false">
                                                    <div class="form-group">
                                         ...
                                         <div class="col-lg-12 mt-3"> 
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                <div class="col-sm-4" runat="server" >
                                                            ...
                                                            <asp:DropDownList ID="ddlDepartment" runat="server" Visible="false" AutoPostBack="True" class="form-control"
                                                              TabIndex="180" >
                                                            </asp:DropDownList>                   
                                           ...
                                           <div class="col-lg-12 mt-3"> 
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                ...
                                                <div class="col-sm-2 text-left">
                                                 ...
                                                 <div class="col-sm-2 text-left">
                                                        <div class="form-group"> 
                                                            <label for="ggfdgfd">Other Ref Doctor</label>                                                                                                                                                                                              
                                                         </div>
                                                      </div> 
                                                   <div class="col-sm-2 text-left">
                                                    <div class="form-group">     
                                    ...
                                    <asp:TextBox ID="txtService" runat="server" TabIndex="13" AutoCompleteType="None"  CssClass="form-control" placeholder="Enter Test Name(*)"
                                        ...
                                        <div class="col-sm-1 text-left">
                                                    <div class="form-group">  
                                                        ...
                                                        class="form-control" placeholder="Enter Qty" TQabIndex="16" OnTextChanged="txtQty_TextChanged" Font-Bold="True" Font-Size="Medium"></asp:TextBox>                    
                                        ...
                                        <div class="col-sm-2 text-left">
                                                    <div class="form-group">  
                                                        <asp:TextBox ID="txtTotalCharges"  runat="server" Visible="false" readonly="true" onkeyPress="return numeric_only(event);"
                                                        CssClass="form-control"  TabIndex="130"></asp:TextBox>                    
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                            ...
                            <SortedDescendingHeaderStyle BackColor="#00547E" />
                                        ...
                                        <div id="InsuranceDetails" runat="server">  
                                                       ...
                                                       <div class="col-sm-2">
                                                        ...
                                                        <asp:TextBox ID="txtInsuranceAmt" runat="server"  CssClass="form-control"  TabIndex="80" OnTextChanged="txtInsuranceAmt_TextChanged1"></asp:TextBox>
                                                               </div>
                                                        </div>
                                                           <div class="col-sm-2">
                                                    <div class="form-group">                                                      
                      ...
                      <asp:RadioButtonList ID="rdblInsuranceAmt" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdblInsuranceAmt_SelectedIndexChanged" >
                          ...
                          <asp:ListItem Value="1">Per(%)</asp:ListItem>
                                                      ...
                                                      <%-- <div class="col-sm-2 text-left" style="width:120px">
                                                           <div class="form-group">  
                                                        <label  style="width:110px" >InsuranceComp: </label>
                                                               </div>
                                                        </div>
                                                       
                                                           <div class="col-sm-2 text-left" style="width:190px">
                                                           <div class="form-group">  
                ...
                <input id="rdbdiscPer" type="radio" runat="server" name="rdbDisc" value="Per" />
                  <label for="rdbdiscPer">Per(%)</label>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      TabIndex="84" AutoPostBack="True" OnTextChanged="txtDiscount_TextChanged" onkeyPress="return numeric_only(event);"></asp:TextBox>
                                        ...
                                        CausesValidation="False" TabIndex="16" CssClass="btn btn-primary" OnClick="btnCaseReport_Click" Visible="False"/>
