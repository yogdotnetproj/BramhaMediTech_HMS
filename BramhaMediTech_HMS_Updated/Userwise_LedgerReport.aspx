<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="Userwise_LedgerReport.aspx.cs" Inherits="Userwise_LedgerReport" %>
...
<asp:DropDownList ID="ddlTimeTo" runat="server" CssClass="form-control form-select"></asp:DropDownList>
                                          ...
                                          <div class="col-sm-1 p-0" runat="server" visible="false">
                                                        <div class="form-group">
                             ...
                             <div class="col-sm-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <asp:Button ID="btnReset" runat="server" onclick="btnReset_Click" CssClass="btn btn-warning" 
                                            Text="Print Excel" />
                                            <asp:Button ID="btnprintService" runat="server" Visible="false" CausesValidation="False" CssClass="btn btn-success" 
                                             Text="Print service wise" OnClick="btnprintService_Click" />

                                              <asp:Button ID="btnExcelService" runat="server" Visible="false"  CssClass="btn btn-warning" 
