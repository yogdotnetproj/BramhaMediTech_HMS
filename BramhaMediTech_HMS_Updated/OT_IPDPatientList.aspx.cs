...
public partial class OT_IPDPatientList : System.Web.UI.Page
{
    ...
    protected void gvPatientInfo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Select")
        {
            ...
            int opd = 0;
            Session["OTRegNo"] = PatRegId;
            Session["OTOpdNo"] = opd;
            Session["OTIpdNo"] = IPDNO;
            ...
            string response = @"~/Caesarean_Section.aspx?RegId=" + PatRegId + "&OpdNo=" + opd + "&Name=" + Name + "&IpdNo=" + IPDNO;//+ "&EntryDate=" + entryDate
