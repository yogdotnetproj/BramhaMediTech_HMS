<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="NurseIPDPatientList.aspx.cs" Inherits="NurseIPDPatientList" %>
     ...
     <Triggers>
        ...
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>IPD Patient List</h1>
            <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">IPD Patient List</li>
                    </ol>
            </section>
