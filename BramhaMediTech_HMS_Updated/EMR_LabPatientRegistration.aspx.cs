...
public partial class EMR_LabPatientRegistration : BaseClass
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Convert.ToString(Request.QueryString["Flag"]) == "Investigation")
            {
                PindPatientInformationInv();
                if (Convert.ToString(Session["EmrIpdNo"]) != "0")
                {
                   // BindTreamentGrid_IPD(Convert.ToInt32(Request.QueryString["RegId"]), Convert.ToInt32(Session["EmrIpdNo"]));
                    BindTreamentGrid(Convert.ToInt32(Request.QueryString["RegId"]));
    ...
    public void PindPatientInformationInv()
    {
        ...
        dt = obj.Get_AllPatientInformationInv(Convert.ToString(Request.QueryString["RegId"]), Convert.ToInt32(Session["Branchid"]));
        try
        {
            if (dt != null)
            {
    ...
    public void PindPatientInformation()
    {
        ...
        try
        {
            if (dt != null)
            {
               ...
               // lblPatientName.Text = Convert.ToString(dt.Rows[0]["PatientName"]);
               ViewState["PatRegId"] = Convert.ToString(dt.Rows[0]["PatRegId"]);
                // lblIpd.Text = "0";
                //if (Convert.ToString(Session["EmrIpdNo"]) != "0")
                //{
                //    Ipd.Visible = true;
    ...
    private void BindTreamentGrid_IPD(int PatRegId,int IPDNo)
    {
        ...
        dtIP = transaction.GetLabInvestigationDetails_IPD(PatRegId, IPDNo);
        //GvNoteIngrid.DataSource = transaction.GetLabInvestigationDetails_IPD(PatRegId,IPDNo);
        if (dtIP.Rows.Count > 0)
        {
            GvNoteIngrid.DataSource = dtIP;
            GvNoteIngrid.DataBind();
            for (int i = 0; i < GvNoteIngrid.Rows.Count; i++)
            {
                HiddenField hdnReqType = GvNoteIngrid.Rows[i].FindControl("hdnReqType") as HiddenField;
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
       ...
       // DropDownList ddl_Receipt = GvNoteIngrid.Rows[row.RowIndex].FindControl("ddlReceipt") as DropDownList;
        ...
        if (HdnPType.Value == "MediallLab")
        {
            ...
            bool DescFlag = false;
            bool textflag = false;
            dtTra = transaction.CheckTestIsDesc(Convert.ToString(HdnLabRegno.Value));
            if (dtTra.Rows.Count > 0)
            {
              
                for (int i = 0; i <= dtTra.Rows.Count - 1; i++)
                {
                    if (Convert.ToString(dtTra.Rows[i]["TextDesc"]) == "TextField")
                    {
                        textflag = true;
                       // DescFlag = true;
                    }
                    if (Convert.ToString(dtTra.Rows[i]["TextDesc"]) == "DescType")
                    {
                       // textflag = true;
                        DescFlag = true;
                    }
            ...
            if (textflag == true && DescFlag == true)
            {
                ...
                CR.Load(Server.MapPath("~//Report//Pateintreportnondescriptive_MediLab.rpt"));
                SqlConnection con = DataAccess.ConInitForMedical();
                SqlDataAdapter sda = null;
                DataTable dt = new DataTable();

                sda = new SqlDataAdapter("select * from VW_patdatvwrecvw_MediLab where PatRegID='" + Convert.ToString(HdnLabRegno.Value) + "'  ", con);
                ...
                path = Server.MapPath("/" + Request.ApplicationPath + "/LABReport/");
                string filename1 = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Nondescriptive" + ".pdf");
                System.IO.File.WriteAllText(filename1, "");
                string exportedpath = "", selectionFormula = "";
                ReportParameterClass.SelectionFormula = "{VW_patdatvwrecvw_MediLab.PatRegID}='" + Convert.ToString(HdnLabRegno.Value) + "'";
                ...
                ReportDocument CRD1 = new ReportDocument();
                CRD1.Load(Server.MapPath("~//Report//Pateintreportdescriptive_MediLab.rpt"));
                SqlConnection con1 = DataAccess.ConInitForMedical();

                int line1 = 10;
                int topMargin = 14 * line1;

                string filename22 = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
                System.IO.File.WriteAllText(filename22, "");

                SqlDataAdapter sda1 = null;
                DataTable dt1 = new DataTable();
                sda1 = new SqlDataAdapter("select * from VW_desfiledata_org_MediLab where PatRegID='" + Convert.ToString(HdnLabRegno.Value) + "'   ", con1);
                sda1.Fill(dt1);



                CRD1.SetDataSource((System.Data.DataTable)dt1);
                ...
                if (CRD1 != null)
                {
                    crReportDocument1 = (ReportDocument)CRD1;
                }
                CrystalDecisions.Shared.PageMargins pm1 = CRD1.PrintOptions.PageMargins;
                ...
                cl.ExportandPrintr("pdf", path, exportedpath, formula, CRD1);
                ...
                if (dt.Rows.Count == 0)
                {
                    string filepath11 = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Nondescriptive" + ".pdf");
                ...
                if (dt1.Rows.Count == 0)
                {
                    string filepath11 = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
                ...
                string OrgFile = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Nondescriptive" + ".pdf");
                string DupFile = Server.MapPath("LABReport//" + "$" + Date2 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Nondescriptive" + ".pdf");
                ...
                {
                    string pathh = Server.MapPath("/" + Request.ApplicationPath + "/LABReport/");
                ...
                urlArr[Obj_A_Test.Length] = "Testnormalresult.aspx?rt=NonDesc&RepName=LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Nondescriptive" + ".pdf";

                targetArr[Obj_A_Test.Length] = "1";
                featuresArr[Obj_A_Test.Length] = "";
                string OrgFileDesc = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
                string DupFileDesc = Server.MapPath("LABReport//" + "$" + Date2 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
                ...
                urlArr[0] = "Redirect.aspx?rt=DescType&RepName=LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf";
            ...
            else if (DescFlag == true)
            {
                ...
                string[] Obj_A_Test = DispDespCode.Split(',');
                string[] targetArr = new string[Obj_A_Test.Length + 1];
                string[] urlArr = new string[Obj_A_Test.Length + 0];
                string[] featuresArr = new string[Obj_A_Test.Length + 1];
                selectonFormula = ReportParameterClass.SelectionFormula;
                ...
                CR.Load(Server.MapPath("~//Report//Pateintreportdescriptive_MediLab.rpt"));
               
                SqlDataAdapter sda = null;
                DataTable dt = new DataTable();
                //  DataSet1 dst = new DataSet1();
                sda = new SqlDataAdapter("select * from VW_desfiledata_org_MediLab where PatRegID='" + Convert.ToString(HdnLabRegno.Value) + "'  ", con);
                ...
                CR.SetDataSource((System.Data.DataTable)dt);
                 ...
                 path = Server.MapPath("/" + Request.ApplicationPath + "/LABReport/");
                 string filename1 = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
                System.IO.File.WriteAllText(filename1, "");
                string exportedpath = "", selectionFormula = "";
                ReportParameterClass.SelectionFormula = "{VW_desfiledata_org_MediLab.PatRegID}='" + Convert.ToString(HdnLabRegno.Value) + "' ";
                ReportDocument crReportDocument = null;
                if (CR != null)
                {
                    crReportDocument = (ReportDocument)CR;
                ...
                string OrgFile = Server.MapPath("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
                string DupFile = Server.MapPath("LABReport//" + "$" + Date2 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
                ...
                ResponseHelper.Redirect(urlArr, targetArr, featuresArr);
               // Response.Redirect("LABReport//" + "$" + Date1 + "$" + Convert.ToString(HdnLabRegno.Value) + "_" + Convert.ToInt32(Session["Branchid"]) + "_" + "Descriptive" + ".pdf");
