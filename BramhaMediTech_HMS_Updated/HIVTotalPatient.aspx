<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalTemp.master" AutoEventWireup="true" CodeFile="HIVTotalPatient.aspx.cs" Inherits="HIVTotalPatient" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>Visit for HIV test done Patient</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Visit for HIV test done patient</li>
                    </ol>
                </section>
