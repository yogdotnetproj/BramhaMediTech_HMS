...
public partial class InsuranceCompTransactionLedger : System.Web.UI.Page
{
    ...
    protected void btnreport_Click(object sender, EventArgs e)
    {
        ...
        { 
            ...
            objreports.InsurancePaymentLedger(txtStart.Text,txtEnd.Text, Sponser, FId, BranchId);

            Session.Add("rptsql", sql);
            Session["rptname"] = Server.MapPath("~/Reports/Rpt_InsurancePaymentLedger.rpt");
            Session["reportname"] = "InsurancePaymentLedger";
