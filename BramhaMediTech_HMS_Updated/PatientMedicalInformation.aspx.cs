...
public partial class PatientMedicalInformation : BaseClass
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        try
        {
            string fileName = "~/Images0/PatientImages/" + Path.GetFileName(FileUpload1.PostedFile.FileName);
            FileUpload1.SaveAs(Server.MapPath("~/Images0/PatientImages/" + FileUpload1.FileName));
