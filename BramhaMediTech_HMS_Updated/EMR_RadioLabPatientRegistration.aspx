<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true" CodeFile="EMR_RadioLabPatientRegistration.aspx.cs" Inherits="EMR_RadioLabPatientRegistration" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Radiology Registration</h1>
                    <ol class="breadcrumb">
                       
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Radiology Registration</li>
                    </ol>
                </section>
                                            ...
                                            <div class="row">
                                                    <div class="form-Inline form-check pl12">
                                                        <asp:RadioButtonList ID="RBLLabType" runat="server"  Enabled="false"  BackColor="#66ccff" RepeatDirection="Horizontal" AutoPostBack="True"  Font-Bold="True" Font-Size="Medium" Width="100%" OnSelectedIndexChanged="RBLLabType_SelectedIndexChanged" >
                                                             ...
                                                             <asp:ListItem Selected="True" Value="R">Radiology</asp:ListItem>                                                            
                                            ...
                                            <asp:TextBox ID="txtTotalCharges"  runat="server" readonly="true" onkeyPress="return numeric_only(event);"
                                              ...
                                              <div class="form-group"> 
                                                      <asp:TextBox ID="txtclinicalHistory" runat="server"  
                                                        AutoPostBack="false" TextMode="MultiLine" placeholder=" Clinical History" TabIndex="15"  Font-Bold="True" Font-Size="Medium" CssClass="form-control"></asp:TextBox>                    
                                              ...
                                              <div class="form-group"> 
                                                  <asp:DropDownList runat="server"  CssClass="form-control form-select"  ID="ddlWardName"></asp:DropDownList>
                                                  </div>
                                                               </div>
                                                               <div id="Div28" class="col-lg-8 " runat="server" >
                                              <div class="form-group">
                                                  <asp:TextBox ID="txtverbalby" runat="server"  
                                                        AutoPostBack="false"   CssClass="form-control" placeholder=" Verbal order by" Font-Bold="True" Font-Size="Medium" ></asp:TextBox>                    
                                                           ...
                                                           <div id="Div29" class="col-lg-12 mt-3 " runat="server" >
                                                          <div class="row">
                                                           <div id="Div30" class="col-lg-12" runat="server" >
                                              <div class="form-group">
