...
public partial class ReportCancelRegistration :BasePage
{
    ...
    protected void FillCancelPatientRegGrid()
    {
        ...
        gvPatientInfo.DataSource = objDALPatInfo.SuspendandResumeList(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]));
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ObjDOReport.Get_SuspendedReport(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]));

            Session.Add("rptsql", sql);
            Session["rptname"] = Server.MapPath("~/Reports/Rpt_SuspendedReport.rpt");
            Session["reportname"] = "SuspendedReport";
