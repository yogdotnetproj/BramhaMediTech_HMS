...
public class Patmstd_Main_Bal_C
{
    ...
    public DataTable GetallMaindoctor_addresult_Doctor(string maindept, string Subdeptid,string DocName)
    {
        ...
        SqlDataAdapter sc = new SqlDataAdapter("SELECT  distinct   DRST.signatureid, DRST.Drsignature FROM CTuser INNER JOIN DRST ON CTuser.Drid = DRST.signatureid INNER JOIN Deptwiseuser ON CTuser.username = Deptwiseuser.username INNER JOIN SubDepartment ON Deptwiseuser.DeptCodeID = SubDepartment.subdeptid where (CTuser.Usertype='Main Doctor' or CTuser.Usertype='MainDoctor') and CTuser.DigModule='" + maindept + "' and subdeptid='" + Subdeptid + "'  and CTuser.username='" + DocName + "' ", conn);
        DataTable ds = new DataTable();
    ...
    public DataTable GetallMaindoctor_addresult(string maindept, string Subdeptid)
    {
        ...
        SqlDataAdapter sc = new SqlDataAdapter("SELECT  distinct   DRST.signatureid, DRST.Drsignature FROM CTuser INNER JOIN DRST ON CTuser.Drid = DRST.signatureid INNER JOIN Deptwiseuser ON CTuser.username = Deptwiseuser.username INNER JOIN SubDepartment ON Deptwiseuser.DeptCodeID = SubDepartment.subdeptid where (CTuser.Usertype='Main Doctor' or CTuser.Usertype='MainDoctor') and CTuser.DigModule='" + maindept + "' and subdeptid='" + Subdeptid + "' ", conn);
        DataTable ds = new DataTable();
