...
public class DrMT_Bal_C
{
    ...
    public bool Update(int branchid)
    {
        ...
        SqlCommand sc = new SqlCommand("" +
            ...
            " Cashbill=@Cashbill,Mainflag=@Mainflag,ratetypeid=@ratetypeid where DoctorCode=@DoctorCode and DrType=@DrType and branchid=" + branchid + "", conn);
    ...
    public bool Insert(int branchid)
    {
        ...
        SqlCommand sc = new SqlCommand("" +
        "insert into DrMT(DoctorCode,DoctorName,city,Doctoremail,DoctorPhoneno,DrInitial,Dateof_entry,DrType,contactperson,Cashbill,Mainflag,ratetypeid,branchid,Address1)" +
        "values(@DoctorCode,@DoctorName,@city,@Doctoremail,@DoctorPhoneno,@prefix,@Dateof_entry,@DrType,@contactperson,@Cashbill,@Mainflag,@ratetypeid,@branchid,@Address1)", conn);
