...
public static class PackageLHMS_Bal_C
{
    public static IList<PackageHMS_Bal_C> Get_PackageDetails(string PCode, int branchid)
    {
        List<PackageHMS_Bal_C> al = new List<PackageHMS_Bal_C>();
        ...
        try
        {
            ...
            if (sdr != null)
            {
                while (sdr.Read())
                {
                    PackageHMS_Bal_C gd = new PackageHMS_Bal_C();
                    ...
                    gd.MTCode = sdr["ServiceId"].ToString();
                    gd.TestName = sdr["ServiceName"].ToString();
    ...
    public static ICollection<PackageHMS_Bal_C> GetPackage_Group(int branchid)
    {
        List<PackageHMS_Bal_C> al = new List<PackageHMS_Bal_C>();
        SqlConnection conn = DataAccess.ConInitForDC();
        ...
        try
        {
            ...
            if (sdr != null)
            {
                while (sdr.Read())
                {
                    PackageHMS_Bal_C gm = new PackageHMS_Bal_C();
