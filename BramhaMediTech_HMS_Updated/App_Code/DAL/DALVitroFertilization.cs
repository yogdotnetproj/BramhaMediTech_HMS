...
/// </summary>
public class DALVitroFertilization
{
    public DALVitroFertilization()
	{
		//
    ...
    //--------------------------------------------------
    private string _AntrialFollicleNote;
    public string AntrialFollicleNote { get { return _AntrialFollicleNote; } set { _AntrialFollicleNote = value; } }
    private string _TrialTransfer;
    public string TrialTransfer { get { return _TrialTransfer; } set { _TrialTransfer = value; } }
    private string _TrialTransferDetalis;
    public string TrialTransferDetalis { get { return _TrialTransferDetalis; } set { _TrialTransferDetalis = value; } }
    private string _Endometrialscrath;
    public string Endometrialscrath { get { return _Endometrialscrath; } set { _Endometrialscrath = value; } }
    private DateTime _Endometria_Date;
    public DateTime Endometria_Date { get { return _Endometria_Date; } set { _Endometria_Date = value; } }
    ...
    private string _DLap;
    public string DLap { get { return _DLap; } set { _DLap = value; } }
    private string _PreviousInfertHist;
    public string PreviousInfertHist { get { return _PreviousInfertHist; } set { _PreviousInfertHist = value; } }
    private string _VitroRemarks;
    public string VitroRemarks { get { return _VitroRemarks; } set { _VitroRemarks = value; } }


    private string _DHEAS;
    public string DHEAS { get { return _DHEAS; } set { _DHEAS = value; } }
    private string _LongAgonist;
    public string LongAgonist { get { return _LongAgonist; } set { _LongAgonist = value; } }
    private string _Antagonist;
    public string Antagonist { get { return _Antagonist; } set { _Antagonist = value; } }
    private DateTime _OCsDate;
    public DateTime OCsDate { get { return _OCsDate; } set { _OCsDate = value; } }
    private string _VitroNote;
    public string VitroNote { get { return _VitroNote; } set { _VitroNote = value; } }
