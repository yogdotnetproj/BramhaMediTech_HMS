<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="MRC_IpdPatientListForDuePayment.aspx.cs" Inherits="IpdPatientListForDuePayment" %>
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>MRC Due IPD Patient List</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">MRC Due IPD Patient List</li>
                    </ol>
            </section>
                               ...
                               <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnSearch" OnClick="btnSearch_Click" runat="server" Text="Search" TabIndex="3" ValidationGroup="Date" CssClass="btn btn-success" />
                                        </div>
                                            </div>
                                    </div>
                                              <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <asp:Button ID="btnReport"  runat="server" Text="Report" TabIndex="3" ValidationGroup="Date" CssClass="btn btn-warning" OnClick="btnReport_Click" />
                                        </div>
                                            </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="table-responsive" style="width: 100%">
                                                <asp:GridView ID="gvPatientInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="IpdId"
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:BoundField DataField="IpdNo" Visible="false" HeaderText="IpdNo" ItemStyle-Width="60" >
                                                        ...
                                                        <asp:BoundField DataField="InvoiceNo" HeaderText="Invoice No" ItemStyle-Width="100"  >
                                                         ...
                                                         <asp:BoundField DataField="BillAmount" Visible="false" HeaderText="Bill Amount" ItemStyle-Width="100"  >
                                                         <ItemStyle Width="100px" />
                                                         </asp:BoundField>
                                                        <asp:ButtonField CommandName="Report" Text="Report" HeaderText="Report" ControlStyle-CssClass="btn btn-success" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-success" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="Summary" Text="Summary" HeaderText="Summary" ControlStyle-CssClass="btn btn-warning" ItemStyle-Width="80" ButtonType="Button" >
