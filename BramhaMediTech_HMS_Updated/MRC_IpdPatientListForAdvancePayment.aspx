<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="MRC_IpdPatientListForAdvancePayment.aspx.cs" Inherits="MRC_IpdPatientListForAdvancePayment" %>
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>MRC IPD patient list for advance payment</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">MRC IPD patient list for advance payment</li>
                    </ol>
            </section>
