...
public partial class SyphilisUrinarytractPatient : System.Web.UI.Page
{
    ...
    public void Alter_view()
    {
        ...
        " where OpdRegistration.branchid=" + Convert.ToInt32(Session["Branchid"]) + " and (ANCExamination.SyphilisTest='True' or ANCExamination.Urinalysis='True')  ";
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/Report/Rpt_VisitForSyphilisUrinarytractPatient.rpt");
        Session["reportname"] = "Rpt_VisitForSyphilisUrinarytractPatient";
