<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="Insurance_Receipt_IPD.aspx.cs" Inherits="Insurance_Receipt_IPD" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>IPD Insurance Receipt</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">IPD Insurance Receipt</li>
                    </ol>
                </section>
