...
public partial class UserWiseCashSummaryReport : System.Web.UI.Page
{
    ...
    protected void Print_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ViewState["FromDate"] = txtFrom.Text.ToString();
               // ViewState["FromDate"] = DateTime.ParseExact(txtFrom.Text, "MM/dd/yyyy", System.Globalization.CultureInfo.InvariantCulture).ToString();
            }
            else
            {
                ViewState["FromDate"] = "";
