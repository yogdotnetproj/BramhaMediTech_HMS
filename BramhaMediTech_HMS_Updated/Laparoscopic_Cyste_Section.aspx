<%@ Page Title="" Language="C#" MasterPageFile="~/OT_mainMaster.master" AutoEventWireup="true" CodeFile="Laparoscopic_Cyste_Section.aspx.cs" Inherits="Laparoscopic_Cyste_Section" %>
    ...
    <Triggers>
        ...
        <ContentTemplate>
            <section class="content-header d-flex">
                    <h1>Laparoscopic Cystectomy</h1>
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="breadcrumb-item active">Laparoscopic Cystectomy</li>
                    </ol>                
                </section>
                        ...
                        <div class="panel-heading">
                            <div class="col-lg-12 text-center">
                                ...
                                <div class="col-sm-3" >
                                       ...
                                       <asp:TextBox ID="txtCystSize" CssClass="form-control"  runat="server" placeholder="Enter Cyst Size" ></asp:TextBox>
                                                </div>
                                    </div>
                                                          <div class="col-sm-2" >
                                            <div class="form-group">
                                       ...
                                       <asp:TextBox ID="txtsite" CssClass="form-control"  runat="server" placeholder="Enter Site" ></asp:TextBox>
                                                </div>
                                    </div>
                                                          <div class="col-sm-1" >
                                            <div class="form-group">
                                ...
                                <div class="col-sm-3" >
                                       ...
                                       <asp:DropDownList ID="ddlDrained"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Primary">YES</asp:ListItem>
                                            <asp:ListItem Value="Secondary">NO</asp:ListItem>
                                      ...
                                      <asp:DropDownList ID="ddlResected"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Primary">YES</asp:ListItem>
                                            <asp:ListItem Value="Secondary">NO</asp:ListItem>
                                ...
                                <div class="col-sm-3" >
                                       ...
                                       <asp:DropDownList ID="ddlOophorectomy"  CssClass="form-control form-select"  runat="server" >
                                          <asp:ListItem Value=""></asp:ListItem>
                                            <asp:ListItem Value="Primary">YES</asp:ListItem>
                                            <asp:ListItem Value="Secondary">NO</asp:ListItem>
                                ...
                                <div class="col-sm-3" >
                                       ...
                                       <asp:TextBox ID="txtcomments" CssClass="form-control" TextMode="MultiLine" Height="70px"  runat="server" placeholder="" ></asp:TextBox>
