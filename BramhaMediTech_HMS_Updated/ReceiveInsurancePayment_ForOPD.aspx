<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="ReceiveInsurancePayment_ForOPD.aspx.cs" Inherits="ReceiveInsurancePayment_ForOPD" %>
                    ...
                    <div class="box-body">
                        <div class="row">
                              ...
                              <div class="col-sm-2">
                                                        ...
                                                        <asp:CheckBox ID="ChkReceipt" Text=" Receipts"  runat="server" AutoPostBack="true" OnCheckedChanged="ChkReceipt_CheckedChanged" CssClass="form-check" ></asp:CheckBox>
                              ...
                              <div class="col-sm-1">
                                        ...
                                        Text=" Print" ToolTip="Print" class="btn btn-success" />
                                                     </div>
                             <div class="col-sm-1">
                                 <asp:Button ID="btnreportAll" runat="server"  OnClick="btnreportAll_Click" 
                                        Text="Print All" ToolTip="Print All" class="btn btn-danger" />
                                 </div>
                                     <div class="col-sm-3">
                                                        <asp:CheckBox ID="ChkIndividual" Text="Individual Receipt"  runat="server" AutoPostBack="true"  CssClass="form-check"  ></asp:CheckBox>

                                                      </div> 
                                       <div class="col-sm-2">
                                           <asp:CheckBox ID="ChkAll" Text=" AllCheck"  runat="server" AutoPostBack="true"  CssClass="form-check" OnCheckedChanged="ChkAll_CheckedChanged" ></asp:CheckBox>
                                  ...
                                  <div class="col-lg-12 mt-3" runat="server" id="PInV">
                                                    ...
                                                    <Columns>  
                                                      ...
                                                      <asp:TemplateField HeaderText="Gen Invoice">
                                                          <ItemTemplate>
                                                              ...
                                                              <asp:CheckBox runat="server" ID="ChkGenInv" AutoPostBack="false" Checked="false" OnCheckedChanged="ChkGenInv_CheckedChanged" />
                                                          </ContentTemplate>
                                                               </asp:UpdatePanel>
                                                         ...
                                                         <asp:TemplateField HeaderText="Rec Amt">
                                                          <ItemTemplate>
                                                              <asp:UpdatePanel ID="UpdatePanel16" runat="server" >
                                                                   <ContentTemplate>
                                                              <asp:TextBox runat="server" ID="txtrecamt" Width="150px" AutoPostBack="false" OnTextChanged="txtrecamt_TextChanged" />
                                                          </ContentTemplate>
                                                               </asp:UpdatePanel>
                                                                        </ItemTemplate>
                                                      </asp:TemplateField>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <asp:Button ID="btnSave" runat="server" CausesValidation="False" UseSubmitBehavior="false" OnClientClick="this.disabled='true';this.Value='Please Wait...';" class="btn btn-success" 
