<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="MRC_IpdPatientList.aspx.cs" Inherits="MRC_IpdPatientList" %>
     ...
     <Triggers>
        ...
        <ContentTemplate>--%>
            <section class="content-header d-flex">
                <h1>MRC IPD Patient List</h1>
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">MRC IPD Patient List</li>
                    </ol>
            </section>
                                                    ...
                                                    <Columns>  
                                                        ...
                                                        <asp:ButtonField CommandName="Report" Text="Report" HeaderText="Report" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         ...
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                           ...
                                                           <asp:ButtonField CommandName="Discharge" Text="Disc summary" HeaderText="Discharge" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-success" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="Resume" Text="Resume" ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-success" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:ButtonField CommandName="Suspend" Text="suspend"  ControlStyle-CssClass="btn btn-primary" ItemStyle-Width="80" ButtonType="Button" >
                                                         <ControlStyle CssClass="btn btn-danger" />
                                                         <ItemStyle HorizontalAlign="Center" Width="70px" />
                                                         </asp:ButtonField>
                                                         <asp:TemplateField>
                                         <ItemTemplate>
                                             <asp:HiddenField ID="HdnIssuspend" runat="server" Value='<%#Eval("Issuspend") %>' />
                                             </ItemTemplate>
                                                             </asp:TemplateField>
