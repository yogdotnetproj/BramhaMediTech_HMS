<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalTemp.master" AutoEventWireup="true" CodeFile="VisitForNumberofNormaldeliveryPatient.aspx.cs" Inherits="VisitForNumberofNormaldeliveryPatient" %>
       ...
       <Triggers>
         ...
         <ContentTemplate>
             ...
             <section class="content-header d-flex">
                    <h1>Visit For number of normal delivery patient</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">Visit For number of delivery patient </li>
                    </ol>
                </section>
