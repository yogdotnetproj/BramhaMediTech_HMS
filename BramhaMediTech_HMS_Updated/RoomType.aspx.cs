...
public partial class RoomType : BaseClass
{
    ...
    protected void FillRoomTypeGrid()
    {
        ...
        gvRoomType.DataSource = objDALRoom.FillGridRoomType();
        gvRoomType.DataBind();
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (!(txtRoomType.Text.Equals(string.Empty)))
        {
            ...
            else
            {
                ...
                Message = objDALRoom.InsertRoomType(objBELRoom);
            }
    ...
    protected void FillPage()
    {
        try
        {
            objBELRoom = objDALRoom.SelectOneRoomType(Convert.ToInt32(ViewState["RTypeId"]));
    ...
    protected void gvRoomType_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            string RTypeId = (gvRoomType.DataKeys[e.NewEditIndex]["RTypeId"].ToString());
    ...
    {
        string RTypeId = (gvRoomType.DataKeys[e.RowIndex]["RTypeId"].ToString());
