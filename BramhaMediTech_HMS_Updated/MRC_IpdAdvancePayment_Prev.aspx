<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="MRC_IpdAdvancePayment_Prev.aspx.cs" Inherits="MRC_IpdAdvancePayment_Prev" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
         ...
         <ContentTemplate>
                ...
                <section class="content-header d-flex">
                    <h1>MRC IPD Advance Payment</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                          <li class="breadcrumb-item active">MRC IPD Advance Payment</li>
                    </ol>
                </section>
                    ...
                    <div class="box">
                                ...
                                <div class="col-lg-12">
                                     <div class="panel-heading" style="font-size:medium;font-weight:bold ;background-color:#B24592" >Patient Information:  
                                          <asp:Label  ID="lblMessage1"  Font-Bold="true" ForeColor="White"  runat="server" Text=""></asp:Label> </div>
                                                 ...
                                                 <asp:Label ID="lblPatName" runat="server"  Font-Bold="True"></asp:Label>
                                                  ...
                                                  <div class="col-lg-12 mt-3" runat="server" >
                                                       ...
                                                       <div class="form-group">
                                                          ...
                                                          <div class="row">
                                                    <div class="col-lg-2 pr-0" runat="server" visible="false">
                                                        <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                             ...
                                             <div class="form-group">
                                                 <div class="row">
                                                  <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="lblBillServiceCharges">Outstanding Balance :</label>  
                                                            </div>
                                                    </div>
                                                  <div class="col-lg-2">
                                                        <div class="form-group">                                                                
                                                  ...
                                                  <div class="col-lg-4">
                                                         <div class="form-group">
                                                              <label for="lblAdvanceAmt">Amount Paid:</label>
                                                             </div>
                                                      </div>                                        
                                                  <div class="col-lg-2">
                                                <div class="form-group">
