<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="GenerateChargeNumber.aspx.cs" Inherits="GenerateChargeNumber" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <section class="content-header d-flex">
                    <h1>Generate Charge Number</h1>
                    <ol class="breadcrumb">  
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>                     
                        <li class="breadcrumb-item active">Generate Charge Number</li>
                    </ol>
                </section>
                                    ...
                                    <div class="row mb-3">                                
                                        ...
                                        <div class="col-lg-4 text-left">   --%>                                 
                                              <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-primary"   OnClick="btnSearch_Click" Text="Search"
                                                 />
                                              <asp:Button ID="btnNew" runat="server" Visible="false" CssClass="btn btn-primary"   onclick="btnNew_Click" Text="New" 
                                                 />
                                        <%--</div>
                             ...
                             <AlternatingRowStyle BackColor="#95deff"></AlternatingRowStyle>
                               ...
                               <asp:BoundField DataField="CreatedBy" HeaderText="Created By" 
                                    ...
                                    <ItemStyle HorizontalAlign="Left"  />
                                              ...
                                              <asp:CommandField ButtonType="Image"  HeaderText="Charge Number" DeleteImageUrl="~/Images0/logout-32.png" 
