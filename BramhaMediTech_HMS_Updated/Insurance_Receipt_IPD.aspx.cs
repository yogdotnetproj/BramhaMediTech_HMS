...
public partial class Insurance_Receipt_IPD : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        ...
        gvDailyCash.DataSource = ObjDOReport.Fill_AllInsurancr_ReceiptIPD(Convert.ToString(ViewState["FromDate"]), Convert.ToString(ViewState["ToDate"]), Convert.ToInt32(Sponser), BranchId, "0"); //Convert.ToInt32(ddlUser.SelectedValue));
